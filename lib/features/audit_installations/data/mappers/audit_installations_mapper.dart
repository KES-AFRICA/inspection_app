...
class AuditInstallationsMapper {
  ...
  static TransformateurMTBTEntity toTransformateurEntity(TransformateurMTBT model) {
    return TransformateurMTBTEntity(
      ...
      syncId: model.syncId,
      observations: model.observations?.map(toElementEntity).toList(),
      intensiteNominale: model.intensiteNominale,
      couplage: model.couplage,
      typeReseau: model.typeReseau,
      pccAmont: model.pccAmont,
      puissanceUcc: model.puissanceUcc,
      ik3Max: model.ik3Max,
      nom: model.nom,
      photo: model.photo,
      repere: model.repere,
  ...
  static TransformateurMTBT toTransformateurModel(TransformateurMTBTEntity entity) {
    return TransformateurMTBT(
      ...
      syncId: entity.syncId,
      observations: entity.observations?.map(toElementModel).toList(),
      intensiteNominale: entity.intensiteNominale,
      couplage: entity.couplage,
      typeReseau: entity.typeReseau,
      pccAmont: entity.pccAmont,
      puissanceUcc: entity.puissanceUcc,
      ik3Max: entity.ik3Max,
      nom: entity.nom,
      photo: entity.photo,
      repere: entity.repere,
      marque: entity.marque,
  ...
  static CoffretArmoireEntity toCoffretEntity(CoffretArmoire model) {
    return CoffretArmoireEntity(
      ...
      transformateurId: model.transformateurId,
      transformateurNomComplet: model.transformateurNomComplet,
      ...
      indiceIpIkRepere: model.indiceIpIkRepere,
  ...
  static CoffretArmoire toCoffretModel(CoffretArmoireEntity entity) {
    return CoffretArmoire(
      ...
      transformateurId: entity.transformateurId,
      transformateurNomComplet: entity.transformateurNomComplet,
      ...
      indiceIpIkRepere: entity.indiceIpIkRepere,

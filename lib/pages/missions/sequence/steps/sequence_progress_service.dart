...
class _SequenceScreenState extends State<SequenceScreen> {
  ...
  Future<void> _loadProgress() async {
    ...
    // S'assurer que le step chargé est dans les limites valides (0 à 6)
  ...
  void _onSchemaComplete() async {
    // Marquer l'étape Schéma comme complétée
    await SequenceProgressService.markStepCompleted(widget.mission.id, 5);
    
    // Passer automatiquement à l'étape Summary
    if (mounted) {
      setState(() {
        _currentStep = 6;
      });

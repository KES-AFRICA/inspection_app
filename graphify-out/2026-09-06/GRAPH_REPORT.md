...
## Corpus Check
- 465 files · ~484,880 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8207 nodes · 11374 edges · 258 communities (232 shown, 14 thin omitted)
...
## Communities (258 total, 14 thin omitted)
...
Cohesion: 0.02
Nodes (107): FoudreAdapter, class FakePathProviderPlatform extends, class MockPathProviderPlatform extends, toEntity, toModel, VerificateurMapper, FoudreMapper, toEntity (+99 more)
...
Cohesion: 0.03
Nodes (58): _ajouterPhotoAObservation, build, _buildBadge, _buildCoffretBadge, _buildCoffretCard, _buildCoffretStat, _buildEmptyState, _buildLocalCard (+50 more)
...
Cohesion: 0.05
Nodes (57): @Timeout, AuditInstallationsElectriquesAdapter, DescriptionInstallationsAdapter, dart:io, Directory, AuditInstallationsElectriques, DescriptionInstallations, package:archive/archive_io.dart (+49 more)

### Community 25 - "MaterialPageRoute"
Cohesion: 0.06
Nodes (35): _sauvegarder, _allerAuClassement, _ajouterEssai, _editerCoffret, _editerObservation, _ajouterCoffret, _ajouterObservation, _allerAuClassement (+27 more)
...
Cohesion: 0.05
Nodes (49): MyApp, InvalidFormatDialog, AnalyticsKpiCards, build, _buildKpiCard, data, isDarkMode, build (+41 more)

### Community 30 - "State"
Cohesion: 0.05
Nodes (56): _EtapeInformationsGenerales, BackupScreen, _BackupScreenState, ForgotPasswordScreen, _ForgotPasswordScreenState, MissionCard, _MissionCardState, LightingMissionDetailScreen (+48 more)
...
Cohesion: 0.06
Nodes (45): @HiveType, AlimentationAdapter, BasseTensionLocalAdapter, BasseTensionZoneAdapter, CelluleAdapter, CircuitTerminalEquipementAdapter, CoffretArmoireAdapter, DepartEquipementAdapter (+37 more)
...
Cohesion: 0.07
Nodes (38): AsyncValue, getAuditInstallationsUseCaseProvider, saveAuditInstallationsUseCaseProvider, getCurrentUserUseCaseProvider, getJsaByMissionUseCaseProvider, saveJsaUseCaseProvider, getRenseignementsGenerauxUseCaseProvider, saveRenseignementsGenerauxUseCaseProvider (+30 more)
...
Cohesion: 0.08
Nodes (24): ../entities/verificateur_entity.dart, checkLoginStatusUseCaseProvider, VerificateurRepositoryImpl, getCurrentUser, isUserLoggedIn, saveCurrentUser, VerificateurRepository, call (+16 more)
...
Cohesion: 0.06
Nodes (29): isKnown, _noneOptions, _normalize, resolve, SourceStatusResolver, statusConnue, statusInconnue, _validProtectionTypes (+21 more)
...
Cohesion: 0.03
Nodes (75): PointEquipmentInfo, accentColor, addMesuresEssaisPages, _bodyBold, _bodyText, borderColor, _buildAbreviationsTable, _buildBlueBoxBanner (+67 more)
...
Cohesion: 0.09
Nodes (20): _areItemListsEqual, _auditBox, buildLocalisationMap, _celluleAliases, clearAllDescriptions, clearSectionDescriptions, _collectAllCellulesMT, _collectAllTransformateursMT (+12 more)
...
### Community 125 - "audit_installations_test.dart"
Cohesion: 0.14
Nodes (15): ../entities/audit_installations_entities.dart, AuditInstallationsRepositoryImpl, AuditInstallationsRepository, getOrCreateAuditInstallations, saveAuditInstallations, call, GetAuditInstallationsUseCase, repository (+7 more)
...
### Community 155 - "mesures_essais_provider.dart"
Cohesion: 0.09
...
Cohesion: 0.05
Nodes (41): Font, RenseignementsGenerauxMapper, toEntity, toModel, buildCoverPage, buildIntervenantsEtResponsabilitesPage, cachedClientLogoImg, cachedClientQrImg (+33 more)
...
Cohesion: 0.13
Nodes (14): hashCode, operator, read, typeId, write, int get, create, createdAt (+6 more)

### Community 168 - "last_report.dart"
Cohesion: 0.17
Nodes (12): hashCode, LastReportAdapter, operator, read, typeId, write, fileName, filePath (+4 more)
...
### Community 183 - "backup_queue_service.dart"
Cohesion: 0.15
...
### Community 243 - "package:path_provider/path_provider.dart"
Cohesion: 0.12
...
## Knowledge Gaps
- **6411 isolated node(s):** `XCTest`, `queryText`, `equipmentType`, `selectedReferenceNormative`, `selectedFamilleRisque` (+6406 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 6699 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **14 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Mission` connect `package:flutter/material.dart` to `hive_service.dart`, `ajouter_local_screen.dart`, `ajouter_coffret_screen.dart`, `mission_card.dart`, `avis_mesures_screen.dart`, `foudre_screen.dart`, `mission_local_data_source.dart`, `backup_service.dart`, `pdf_photos_deduplication_test.dart`, `essais_declenchement_screen.dart`, `ajouter_foudre_screen.dart`, `cpi_sequence_screen.dart`, `general_info_step.dart`, `description_installations_form.dart`, `jsa_step.dart`, `sequence_screen.dart`, `detail_zone_screen.dart`, `mission.dart`, `lighting_mission_detail_screen.dart`, `detail_coffret_screen.dart`, `detail_local_screen.dart`, `paratonnerre_screen.dart`, `mission_team_section.dart`, `package:inspec_app/services/hive_service.dart`, `audit_installations.dart`, `moyenne_tension_screen.dart`, `renseignements_generaux_local_data_source.dart`, `essais_isolement_screen.dart`, `conditions_mesure_screen.dart`, `summary_step.dart`, `@HiveType`, `ajouter_zone_screen.dart`, `demarrage_auto_screen.dart`, `mesures_essais_local_data_source.dart`, `classement_emplacement_screen.dart`, `foudre_local_data_source.dart`, `basse_tension_screen.dart`, `status_action_button.dart`, `qr_scan_coffret_screen.dart`, `jsa_standalone_screen.dart`, `mission_hub_screen.dart`, `lighting_inspection.dart`, `description_installations_sequence.dart`, `prises_terre_screen.dart`, `schema_step.dart`, `lighting_summary_screen.dart`, `continuite_resistance_screen.dart`, `create_mission_screen.dart`, `descriptionInstallationsProvider`, `List`, `mission_detail_screen.dart`, `pdf_report_context.dart`, `mesures_essais_screen.dart`, `classement_zone_screen.dart`, `mission_analytics_detail_screen.dart`, `VoidCallback?`, `radio_sequence_screen.dart`, `jsa_local_data_source.dart`, `radio_selection_screen.dart`, `status_selector_modal.dart`, `alimentation_site_mt_sequence_screen.dart`, `client_logo_screen.dart`, `item_detail_screen.dart`, `mission_backup_card.dart`, `installation_detail.dart`, `description_step.dart`, `description_installations_screen/description_installations.dart`?**
...
- **What connects `XCTest`, `queryText`, `equipmentType` to the rest of the system?**
  _6411 weakly-connected nodes found - possible documentation gaps or missing edges._

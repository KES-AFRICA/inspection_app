...
## Corpus Check
- 500 files · ~846,459 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9002 nodes · 12411 edges · 276 communities (247 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `861c7550`
...
Cohesion: 0.02
Nodes (112): FoudreAdapter, class FakePathProviderPlatform extends, class MockPathProviderPlatform extends, toEntity, toModel, VerificateurMapper, FoudreMapper, toEntity (+104 more)
...
Cohesion: 0.04
Nodes (48): package:flutter_test/flutter_test.dart, package:inspec_app/features/audit_installations/data/mappers/audit_installations_mapper.dart, package:inspec_app/features/audit_installations/domain/entities/audit_installations_entities.dart, package:inspec_app/main.dart, package:inspec_app/models/audit_installations_electriques.dart, package:inspec_app/services/dispositions_constructives_registry.dart, package:inspec_app/services/equipment_number_service.dart, package:inspec_app/services/equipment_source_search_service.dart (+40 more)
...
Cohesion: 0.05
Nodes (53): dart:io, Directory, AuditInstallationsElectriques, DescriptionInstallations, package:archive/archive_io.dart, package:flutter/services.dart, package:hive/hive.dart, package:inspec_app/features/backup/data/datasources/backup_job_store.dart (+45 more)
...
### Community 26 - "home_app_bar.dart"
Cohesion: 0.14
...
Cohesion: 0.05
Nodes (40): InvalidFormatDialog, MissionHeader, AnalyticsKpiCards, build, _buildKpiCard, data, isDarkMode, build (+32 more)

### Community 30 - "State"
Cohesion: 0.06
Nodes (45): _EtapeInformationsGenerales, BackupScreen, _BackupScreenState, AddNonConformingLuminaireSheet, _AddNonConformingLuminaireSheetState, LightingInspectionFormScreen, _LightingInspectionFormScreenState, ClientLogoScreen (+37 more)
...
Cohesion: 0.04
Nodes (56): getAllReportsForMissionUseCaseProvider, getRenseignementsGenerauxUseCaseProvider, saveLastReportUseCaseProvider, updateMissionStatusUseCaseProvider, updateMissionStatus, _buildBottomNavigation, _buildCircleActionButton, _buildGenerateButton (+48 more)
...
Cohesion: 0.05
Nodes (43): ../datasources/auth_local_data_source.dart, ../../domain/entities/verificateur_entity.dart, ../../domain/repositories/verificateur_repository.dart, ../entities/verificateur_entity.dart, checkLoginStatusUseCaseProvider, AuthLocalDataSource, AuthLocalDataSourceImpl, _currentUserKey (+35 more)
...
### Community 87 - "mission_execution.dart"
Cohesion: 0.14
...
Cohesion: 0.06
Nodes (47): AsyncValue, Future, getAuditInstallationsUseCaseProvider, saveAuditInstallationsUseCaseProvider, getCurrentUserUseCaseProvider, getMesuresEssaisUseCaseProvider, saveMesuresEssaisUseCaseProvider, addDocumentPersonnaliseUseCaseProvider (+39 more)
...
Cohesion: 0.20
Nodes (9): JsaDangersMapper, JsaEpiMapper, JsaExigencesGeneralesMapper, JsaInspecteurMapper, JsaMapper, JsaPlanUrgenceMapper, JsaVerificationFinaleMapper, toEntity (+1 more)
...
Cohesion: 0.04
Nodes (63): ConsumerWidget, ../../data/services/backup_orchestrator.dart, ../../domain/models/microsoft_user_profile.dart, ../../domain/models/mission_sync_state.dart, double get, backupOrchestratorStateProvider, backupQueueServiceProvider, backupSchedulerServiceProvider (+55 more)
...
Cohesion: 0.09
Nodes (22): BackupSyncStateNotifier, build, champs, _controllers, createState, dispose, index, _initializeControllers (+14 more)
...
Cohesion: 0.06
Nodes (43): buildAnalyseStatistique, _buildBt2ColumnTable, _buildBtCoupureTable, _buildBtParafoudreTable, _buildBtSourceTable, _buildCalloutBox, _buildCrossAuditTable, _buildDynamicParetoExplanation (+35 more)
...
### Community 125 - "package:inspec_app/models/mesures_essais.dart"
Cohesion: 0.09
Nodes (17): addSommairePages, buildSommaireEntryLine, collectSommaireEntries, fontBold, fontRegular, getSommaireEntriesForTesting, hasUnknownSources, logoKesImage (+9 more)
...
Cohesion: 0.04
Nodes (43): _buildAlimentationSiteMtTable, _buildCpiTable, buildDescriptionInstallationsMulti, _buildInstallationTable, _buildInstallationTableFromRows, collectRiskZonesAndLocauxForTesting, _collectRiskZonesAndLocauxStructured, fontBold (+35 more)
...
### Community 146 - "microsoft_graph_storage_service.dart"
Cohesion: 0.05
Nodes (44): ../ai_provider.dart, Client, dart:async, dart:convert, dart:math, ../../domain/models/backup_cancel_token.dart, cancelUploadSession, _chunkSize (+36 more)
...
### Community 152 - "jsa_provider.dart"
Cohesion: 0.09
Nodes (26): ../entities/jsa_entity.dart, getJsaByMissionUseCaseProvider, saveJsaUseCaseProvider, JsaRepositoryImpl, getOrCreateJSA, JsaRepository, saveJSA, call (+18 more)
...
Cohesion: 0.08
Nodes (23): msalRecommendationServiceProvider, build, createState, _isVisible, MsalRecommendationBanner, _MsalRecommendationBannerState, onConnectPressed, build (+15 more)
...
### Community 158 - "local_backup_store.dart"
Cohesion: 0.18
...
### Community 162 - "pdf_cover_builder.dart"
Cohesion: 0.08
Nodes (23): buildCoverPage, buildIntervenantsEtResponsabilitesPage, cachedClientLogoImg, cachedClientQrImg, coverInfoRow, docStatus, fontBold, fontRegular (+15 more)

### Community 163 - "package:inspec_app/models/mission.dart"
Cohesion: 0.04
Nodes (54): BoxDecoration, Column, Container, Font, buildMaterielTable, buildNormesTable, buildPerimetreTable, fontBold (+46 more)
...
### Community 168 - "pdf_chunk_merger.dart"
Cohesion: 0.18
...
Cohesion: 0.14
Nodes (13): ../datasources/jsa_local_data_source.dart, ../../domain/entities/jsa_entity.dart, ../../domain/repositories/jsa_repository.dart, getOrCreateJSA, _jsaBox, JsaLocalDataSource, JsaLocalDataSourceImpl, _missionBox (+5 more)
...
Cohesion: 0.09
Nodes (24): AuditInstallationsRepository get, Completer, ../entities/audit_installations_entities.dart, AuditInstallationsRepositoryImpl, AuditInstallationsElectriquesEntity, AuditInstallationsRepository, getOrCreateAuditInstallations, saveAuditInstallations (+16 more)

### Community 207 - "package:flutter/foundation.dart"
Cohesion: 0.04
Nodes (53): ../../domain/models/backup_job.dart, isKnown, _noneOptions, _normalize, resolve, SourceStatusResolver, statusConnue, statusInconnue (+45 more)
...
### Community 238 - "get_mission_by_id_use_case.dart"
Cohesion: 0.29
...
### Community 240 - "_ForgotPasswordScreenState"
Cohesion: 0.29
...
### Community 242 - "persistence_queue.dart"
Cohesion: 0.29
...
### Community 250 - "package:inspec_app/utils/normative_reference_cleaner.dart"
Cohesion: 0.40
...
Cohesion: 0.04
Nodes (47): 10 Catégories Canoniques de Défauts (Pareto), 10. Data & Persistence (Hive), 11. Migration & Backward Compatibility, 12. State Management (Riverpod), 13. Performance & Resource Management, 14. Security & Sensitive Data, 15. Testing & Quality Assurance, 16. UI/UX Design System & Ergonomics (+39 more)
...
## Knowledge Gaps
- **7109 isolated node(s):** `XCTest`, `queryText`, `equipmentType`, `selectedReferenceNormative`, `selectedFamilleRisque` (+7104 more)
...
- **Why does `Mission` connect `package:flutter/material.dart` to `hive_service.dart`, `ajouter_local_screen.dart`, `ajouter_coffret_screen.dart`, `mission_card.dart`, `avis_mesures_screen.dart`, `foudre_screen.dart`, `installation_detail.dart`, `demarrage_auto_screen.dart`, `backup_service.dart`, `pdf_photos_deduplication_test.dart`, `essais_declenchement_screen.dart`, `jsa_step.dart`, `alimentation_site_mt_sequence_screen.dart`, `description_installations_form.dart`, `general_info_step.dart`, `sequence_screen.dart`, `detail_zone_screen.dart`, `mission.dart`, `lighting_mission_detail_screen.dart`, `detail_coffret_screen.dart`, `detail_local_screen.dart`, `paratonnerre_screen.dart`, `status_selector_modal.dart`, `VoidCallback?`, `ajouter_foudre_screen.dart`, `audit_installations.dart`, `package:inspec_app/services/hive_service.dart`, `moyenne_tension_screen.dart`, `essais_isolement_screen.dart`, `MaterialPageRoute`, `summary_step.dart`, `mission_analytics_detail_screen.dart`, `ajouter_zone_screen.dart`, `classement_emplacement_screen.dart`, `foudre_local_data_source.dart`, `jsa_local_data_source.dart`, `basse_tension_screen.dart`, `mesuresEssaisProvider`, `qr_scan_coffret_screen.dart`, `jsa_standalone_screen.dart`, `mission_hub_screen.dart`, `lighting_inspection.dart`, `renseignements_generaux_local_data_source.dart`, `prises_terre_screen.dart`, `description_installations_sequence.dart`, `schema_step.dart`, `cpi_tests_list_screen.dart`, `lighting_summary_screen.dart`, `continuite_resistance_screen.dart`, `create_mission_screen.dart`, `mission_local_data_source.dart`, `descriptionInstallationsProvider`, `mission_detail_screen.dart`, `pdf_report_context.dart`, `status_action_button.dart`, `classement_zone_screen.dart`, `mission_execution.dart`, `mission_team_section.dart`, `radio_sequence_screen.dart`, `cpi_sequence_screen.dart`, `arret_urgence_screen.dart`, `radio_selection_screen.dart`, `sauvegardes_screen.dart`, `client_logo_screen.dart`, `item_detail_screen.dart`, `cpi_test_form_screen.dart`, `@HiveType`, `description_step.dart`, `description_installations_screen/description_installations.dart`?**
...
- **Why does `AuditInstallationsElectriques` connect `package:inspec_app/services/hive_service.dart` to `moyenne_tension_screen.dart`, `hive_service.dart`, `audit_installations_electriques.dart`, `backup_service.dart`, `pdf_photos_deduplication_test.dart`, `pdf_report_context.dart`, `package:flutter/foundation.dart`, `basse_tension_screen.dart`, `installation_description_sync_service.dart`, `@HiveType`, `lighting_inspection.dart`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **What connects `XCTest`, `queryText`, `equipmentType` to the rest of the system?**
  _7109 weakly-connected nodes found - possible documentation gaps or missing edges._

...
## Corpus Check
- 474 files · ~505,226 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8471 nodes · 11740 edges · 279 communities (238 shown, 29 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0c938733`
...
- ClassementZone
- renseignements_generaux_persistence_test.dart
...
## Communities (279 total, 29 thin omitted)
...
Cohesion: 0.04
Nodes (66): FoudreAdapter, toEntity, toModel, VerificateurMapper, FoudreMapper, toEntity, toModel, RenseignementsGenerauxMapper (+58 more)
...
Cohesion: 0.03
Nodes (57): package:archive/archive_io.dart, package:flutter_test/flutter_test.dart, package:inspec_app/core/utils/source_status_resolver.dart, package:inspec_app/features/audit_installations/data/mappers/audit_installations_mapper.dart, package:inspec_app/features/audit_installations/domain/entities/audit_installations_entities.dart, package:inspec_app/models/audit_installations_electriques.dart, package:inspec_app/services/cellule_types_registry.dart, package:inspec_app/services/dispositions_constructives_registry.dart (+49 more)
...
Cohesion: 0.05
Nodes (55): @Timeout, AuditInstallationsElectriquesAdapter, DescriptionInstallationsAdapter, dart:io, Directory, AuditInstallationsElectriques, DescriptionInstallations, package:crypto/crypto.dart (+47 more)

### Community 25 - "package:pdf/widgets.dart"
Cohesion: 0.10
Nodes (22): Column, Container, package:inspec_app/services/pdf/builders/pdf_audit_installations_builder.dart, package:inspec_app/services/pdf/builders/pdf_cover_builder.dart, package:inspec_app/services/pdf/builders/pdf_equipements_synthesis_builder.dart, package:inspec_app/services/pdf/builders/pdf_executive_summary_builder.dart, package:inspec_app/services/pdf/builders/pdf_mesures_essais_builder.dart, package:inspec_app/services/pdf/builders/pdf_photos_schemas_builder.dart (+14 more)

### Community 26 - "VoidCallback?"
Cohesion: 0.05
Nodes (33): GlobalKey, build, confirmText, LocalDeletionWarningDialog, message, onConfirm, show, title (+25 more)
...
### Community 30 - "State"
Cohesion: 0.06
Nodes (54): _EtapeInformationsGenerales, BackupScreen, _BackupScreenState, ForgotPasswordScreen, _ForgotPasswordScreenState, MissionCard, _MissionCardState, MissionDetailScreen (+46 more)
...
Cohesion: 0.06
Nodes (35): _allerAuClassement, _ajouterEssai, _ajouterObservation, _editerCoffret, _editerEssai, _ajouterCoffret, _ajouterObservation, _allerAuClassement (+27 more)
...
### Community 56 - "package:inspec_app/models/last_report.dart"
Cohesion: 0.06
...
Cohesion: 0.06
Nodes (31): ../datasources/auth_local_data_source.dart, ../../domain/entities/verificateur_entity.dart, ../../domain/repositories/verificateur_repository.dart, ../entities/verificateur_entity.dart, checkLoginStatusUseCaseProvider, authLocalDataSource, getCurrentUser, isUserLoggedIn (+23 more)
...
Cohesion: 0.13
Nodes (15): _annuler, build, ConditionsMesureScreen, _ConditionsMesureScreenState, createState, dispose, _hasData, initState (+7 more)

### Community 102 - "sauvegardes_screen.dart"
Cohesion: 0.05
Nodes (49): ../../domain/models/microsoft_user_profile.dart, double get, backupSchedulerServiceProvider, backupSyncNotifierProvider, microsoftAuthNotifierProvider, microsoftAuthServiceProvider, msalRecommendationServiceProvider, _BackupHeaderSliverDelegate (+41 more)
...
### Community 121 - "package:inspec_app/core/di/injection_container.dart"
Cohesion: 0.12
...
### Community 136 - "description_installations_provider.dart"
Cohesion: 0.12
...
Cohesion: 0.08
Nodes (28): mesuresEssaisProvider, _sauvegarder, _transfererEssais, _loadMesures, _supprimerMesure, build, createState, DemarrageAutoScreen (+20 more)
...
### Community 168 - "stats_app_bar.dart"
Cohesion: 0.12
Nodes (14): build, _buildPeriodChip, isCustomPeriod, onResetPeriod, periodLabel, selectedPeriod, StatsAppBar, build (+6 more)

### Community 169 - "mission_local_data_source.dart"
Cohesion: 0.08
Nodes (24): AuthLocalDataSource, AuthLocalDataSourceImpl, _currentUserKey, getCurrentUser, isUserLoggedIn, saveCurrentUser, _verificateurBox, addDocumentPersonnalise (+16 more)
...
Cohesion: 0.07
Nodes (21): BlocOrigineEssai, deduplicateEssais, EssaiDeclenchementHelper, getPrecisionForBloc, isEligibleForEssai, isSameBlock, precisionCircuit, precisionDepart (+13 more)
...
### Community 195 - "Map"
Cohesion: 0.22
Nodes (11): AsyncValue, getRenseignementsGenerauxUseCaseProvider, saveRenseignementsGenerauxUseCaseProvider, backupOrchestratorProvider, BackupSyncStateNotifier, MicrosoftAuthNotifier, load, RenseignementsGenerauxNotifier (+3 more)
...
### Community 200 - "local_backup_store.dart"
Cohesion: 0.08
...
### Community 204 - "package:inspec_app/services/normative_search_service.dart"
Cohesion: 0.24
...
### Community 206 - "app_bottom_sheet.dart"
Cohesion: 0.25
...
### Community 211 - "List"
Cohesion: 0.08
Nodes (22): backups, build, _buildBackupCard, isLoading, onRefresh, RecentBackupsList, _availableStatuses, build (+14 more)
...
### Community 220 - "pdf_cancellation_test.dart"
Cohesion: 0.33
Nodes (4): package:inspec_app/services/cancellation_token.dart, package:inspec_app/services/pdf/pdf_chunk_merger.dart, main, main
...
### Community 238 - "migration_helper.dart"
Cohesion: 0.50
...
### Community 243 - "renseignements_generaux_persistence_test.dart"
Cohesion: 0.50
...
## Knowledge Gaps
- **6635 isolated node(s):** `XCTest`, `queryText`, `equipmentType`, `selectedReferenceNormative`, `selectedFamilleRisque` (+6630 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 6926 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **29 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Mission` connect `package:flutter/material.dart` to `hive_service.dart`, `ajouter_local_screen.dart`, `ajouter_coffret_screen.dart`, `mission_card.dart`, `avis_mesures_screen.dart`, `foudre_screen.dart`, `installation_detail.dart`, `backup_service.dart`, `autonomous_observation_test.dart`, `essais_declenchement_screen.dart`, `ajouter_foudre_screen.dart`, `jsa_step.dart`, `alimentation_site_mt_sequence_screen.dart`, `description_installations_form.dart`, `general_info_step.dart`, `sequence_screen.dart`, `mesuresEssaisProvider`, `mission.dart`, `lighting_mission_detail_screen.dart`, `detail_coffret_screen.dart`, `detail_local_screen.dart`, `detail_zone_screen.dart`, `paratonnerre_screen.dart`, `VoidCallback?`, `package:inspec_app/services/hive_service.dart`, `audit_installations.dart`, `package:inspec_app/constants/app_theme.dart`, `mission_team_section.dart`, `moyenne_tension_screen.dart`, `essais_isolement_screen.dart`, `mission_local_data_source.dart`, `summary_step.dart`, `mission_analytics_detail_screen.dart`, `ajouter_zone_screen.dart`, `classement_emplacement_screen.dart`, `arret_urgence_screen.dart`, `foudre_local_data_source.dart`, `basse_tension_screen.dart`, `status_action_button.dart`, `qr_scan_coffret_screen.dart`, `jsa_standalone_screen.dart`, `mission_hub_screen.dart`, `lighting_inspection.dart`, `description_installations_sequence.dart`, `prises_terre_screen.dart`, `schema_step.dart`, `documents_step.dart`, `cpi_tests_list_screen.dart`, `lighting_summary_screen.dart`, `continuite_resistance_screen.dart`, `create_mission_screen.dart`, `descriptionInstallationsProvider`, `mission_detail_screen.dart`, `pdf_report_context.dart`, `pdf_photos_deduplication_test.dart`, `List`, `classement_zone_screen.dart`, `radio_sequence_screen.dart`, `jsa_local_data_source.dart`, `radio_selection_screen.dart`, `conditions_mesure_screen.dart`, `client_logo_screen.dart`, `item_detail_screen.dart`, `cpi_test_form_screen.dart`, `mesures_essais_screen.dart`, `mission_backup_card.dart`, `cpi_sequence_screen.dart`, `renseignements_generaux_local_data_source.dart`, `@HiveType`, `description_installations_screen/description_installations.dart`?**
...
- **What connects `XCTest`, `queryText`, `equipmentType` to the rest of the system?**
  _6635 weakly-connected nodes found - possible documentation gaps or missing edges._

...
## Corpus Check
- 526 files · ~873,672 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9264 nodes · 12798 edges · 301 communities (257 shown, 22 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ec3aa849`
...
- _CpiZoneGroup
- AjouterCarteScreen
- mesures_essais_local_data_source.dart
- _DdrRowItem
...
### Community 6 - "pdf_schema_section_test.dart"
Cohesion: 0.03
Nodes (86): AuditInstallationsElectriquesAdapter, FoudreAdapter, class FakePathProviderPlatform extends, class MockPathProviderPlatform extends, toEntity, toModel, VerificateurMapper, FoudreMapper (+78 more)
...
Cohesion: 0.03
Nodes (68): package:flutter_test/flutter_test.dart, package:inspec_app/core/utils/source_status_resolver.dart, package:inspec_app/features/audit_installations/data/mappers/audit_installations_mapper.dart, package:inspec_app/features/audit_installations/domain/entities/audit_installations_entities.dart, package:inspec_app/features/mesures_essais/data/mappers/mesures_essais_mapper.dart, package:inspec_app/main.dart, package:inspec_app/models/audit_installations_electriques.dart, package:inspec_app/models/mesures_essais.dart (+60 more)

### Community 9 - "jsa.dart"
Cohesion: 0.02
Nodes (102): hashCode, JSADangersAdapter, JSAEPIAdapter, JSAExigencesGeneralesAdapter, JSAInspecteurAdapter, JSAPlanUrgenceAdapter, JSAVerificationFinaleAdapter, operator (+94 more)

### Community 10 - "mesures_essais.dart"
Cohesion: 0.02
Nodes (103): AvisMesuresTerreAdapter, ConditionMesureAdapter, EssaiDeclenchementDifferentielAdapter, EssaiDemarrageAutoAdapter, EssaiIsolementAdapter, hashCode, operator, read (+95 more)
...
Cohesion: 0.03
Nodes (61): _ajouterEssai, _ajouterObservation, _ajouterPhotoAObservation, build, _buildAlimentationCard, _buildBooleanInfo, _buildCoffretStats, _buildEssaiCard (+53 more)
...
Cohesion: 0.05
Nodes (51): DescriptionInstallationsAdapter, dart:io, Directory, DescriptionInstallations, migrateExistingUsers, MigrationHelper, package:archive/archive_io.dart, package:crypto/crypto.dart (+43 more)

### Community 25 - "technical_enrichment_engine.dart"
Cohesion: 0.01
Nodes (236): get, ip_ik_evaluator.dart, absentCount, absentPct, absents, adequatCount, AdequationIccPdcStats, adequatPct (+228 more)

### Community 26 - "mesures_essais_screen.dart"
Cohesion: 0.07
...
Cohesion: 0.05
Nodes (44): Color, MyApp, InvalidFormatDialog, MissionHeader, AnalyticsKpiCards, build, _buildKpiCard, data (+36 more)

### Community 30 - "State"
Cohesion: 0.06
Nodes (50): _EtapeInformationsGenerales, BackupScreen, _BackupScreenState, ForgotPasswordScreen, _ForgotPasswordScreenState, LightingMissionDetailScreen, _LightingMissionDetailScreenState, MissionDetailScreen (+42 more)
...
Cohesion: 0.04
Nodes (56): auditInstallationsProvider, _refreshAllData, _supprimerZone, _ajouterZone, _audit, build, _buildBadge, _buildClassementTab (+48 more)
...
### Community 35 - "pdf_cover_builder.dart"
Cohesion: 0.09
Nodes (22): Font, buildCoverPage, _buildCoverTableDataCell, _buildCoverTableHeaderCell, buildIntervenantsEtResponsabilitesPage, cachedClientLogoImg, cachedClientQrImg, coverInfoRow (+14 more)
...
Cohesion: 0.07
Nodes (46): init, sl, getMissionsUseCaseProvider, AddDocumentPersonnaliseUseCase, GetAllReportsForMissionUseCase, GetMissionByIdUseCase, GetMissionsUseCase, RemoveDocumentPersonnaliseUseCase (+38 more)
...
Cohesion: 0.12
Nodes (23): createFoudreObservationUseCaseProvider, deleteFoudreObservationUseCaseProvider, getFoudreObservationsUseCaseProvider, updateFoudreObservationUseCaseProvider, CreateFoudreObservationUseCase, DeleteFoudreObservationUseCase, GetFoudreObservationsUseCase, UpdateFoudreObservationUseCase (+15 more)

### Community 43 - "summary_step.dart"
Cohesion: 0.04
Nodes (54): getAllReportsForMissionUseCaseProvider, saveLastReportUseCaseProvider, _buildBottomNavigation, _buildCircleActionButton, _buildGenerateButton, _buildMissionInfoCard, _buildReportCard, _buildReportDateCard (+46 more)
...
### Community 54 - "renseignements_generaux_repository_impl.dart"
Cohesion: 0.10
Nodes (19): ../datasources/renseignements_generaux_local_data_source.dart, ../../domain/entities/renseignements_generaux_entity.dart, ../../domain/repositories/renseignements_generaux_repository.dart, ../entities/renseignements_generaux_entity.dart, getOrCreateRenseignementsGeneraux, localDataSource, RenseignementsGenerauxRepositoryImpl, saveRenseignementsGeneraux (+11 more)
...
Cohesion: 0.04
Nodes (43): IconData, _animController, badgeBgColor, badgeColor, badgeText, build, _buildClientLogoCard, _buildElectricCard (+35 more)

### Community 60 - "lighting_inspection.dart"
Cohesion: 0.07
Nodes (28): hashCode, LightingInspectionAdapter, operator, read, typeId, write, answers, batimentLocal (+20 more)

### Community 61 - "backup_providers.dart"
Cohesion: 0.06
Nodes (40): AsyncValue, ../../data/datasources/backup_job_store.dart, ../../data/datasources/backup_queue_service.dart, ../../data/datasources/microsoft_auth_service.dart, ../../data/datasources/microsoft_graph_storage_service.dart, ../../data/repositories/backup_sync_repository_impl.dart, ../../data/services/app_update_migration_service.dart, ../../data/services/backup_job_manager.dart (+32 more)
...
Cohesion: 0.09
Nodes (23): ../entities/verificateur_entity.dart, checkLoginStatusUseCaseProvider, VerificateurRepositoryImpl, getCurrentUser, isUserLoggedIn, saveCurrentUser, VerificateurRepository, call (+15 more)
...
### Community 84 - "stats_filter_bar.dart"
Cohesion: 0.07
...
### Community 87 - "package:pdf/widgets.dart"
Cohesion: 0.04
Nodes (56): Column, Container, buildRenseignementsGeneraux, _buildTwoColumnInfoRow, fontBold, fontRegular, fsBody, fsSmall (+48 more)
...
Cohesion: 0.11
Nodes (18): _buildNavigationTile, _buildSectionHeader, _buildStatusBadge, currentPageIndex, filteredMissions, _logout, onClose, onRefreshMissions (+10 more)
...
### Community 95 - "microsoft_graph_storage_service.dart"
Cohesion: 0.06
Nodes (34): ../ai_provider.dart, Client, dart:async, dart:convert, dart:math, ../../domain/models/backup_cancel_token.dart, cancelUploadSession, _chunkSize (+26 more)
...
Cohesion: 0.06
Nodes (29): _applyHorizontalSeparator, _buildEquipementsSheet, buildExcelReportFileName, _buildObservationsSheet, _colorAccentBlue, _colorBorder, _colorHeaderBg, _colorHeaderFont (+21 more)

### Community 101 - "pdf_executive_summary_builder.dart"
Cohesion: 0.06
Nodes (31): _build12IndicateursTable, build12IndicateursTableForTesting, _buildAdequationTable, _buildAppreciationGlobaleText, _buildCablesTable, _buildCategoryCrossTable, buildCategoryCrossTableForTesting, _buildCourbesTable (+23 more)

### Community 102 - "mission_backup_card.dart"
Cohesion: 0.11
Nodes (23): ConsumerWidget, ../../data/services/backup_orchestrator.dart, ../../domain/models/mission_sync_state.dart, backupOrchestratorStateProvider, backupQueueServiceProvider, backupSyncNotifierProvider, build, _refresh (+15 more)
...
Cohesion: 0.12
Nodes (13): package:inspec_app/features/description_installations/data/mappers/description_installations_mapper.dart, package:inspec_app/features/description_installations/domain/entities/description_installations_entity.dart, package:inspec_app/features/description_installations/domain/entities/installation_item_entity.dart, package:inspec_app/models/description_installations.dart, package:inspec_app/models/pdf/installation_description_pdf_data.dart, main, main, main (+5 more)
...
### Community 108 - "description_installations_provider.dart"
Cohesion: 0.12
...
Cohesion: 0.05
Nodes (46): ../datasources/backup_job_store.dart, ../datasources/local_backup_store.dart, ../datasources/microsoft_auth_service.dart, ../datasources/microsoft_graph_storage_service.dart, ../../domain/models/cloud_backup_manifest.dart, ../../domain/repositories/backup_sync_repository.dart, MicrosoftAuthService, MicrosoftGraphStorageService (+38 more)

### Community 112 - "installation_description_pdf_data.dart"
Cohesion: 0.09
Nodes (20): btRows, _collectAllCellules, _collectAllTransformateurs, _createRowFromCellule, _createRowFromCelluleAndItem, _createRowFromItemOnly, _createRowFromTransformateur, _createRowFromTransformateurAndItem (+12 more)

### Community 113 - "ajouter_foudre_screen.dart"
Cohesion: 0.11
...
Cohesion: 0.07
Nodes (35): BoxDecoration, package:inspec_app/services/ai/executive_summary_snapshot.dart, package:inspec_app/services/pdf/builders/pdf_executive_summary_builder.dart, package:inspec_app/services/pdf/builders/pdf_statistics_builder.dart, package:inspec_app/services/pdf/builders/pdf_statistics_charts.dart, package:inspec_app/services/statistics/audit_finding.dart, package:inspec_app/services/statistics/canonical_risk_family_registry.dart, package:inspec_app/services/statistics/competency_needs_engine.dart (+27 more)

### Community 115 - "pdf_mesures_essais_builder.dart"
Cohesion: 0.03
Nodes (69): PointEquipmentInfo, accentColor, addMesuresEssaisPages, armoireGroups, armoireName, _bodyBold, _bodyText, borderColor (+61 more)
...
### Community 121 - "class"
Cohesion: 0.24
Nodes (9): getRenseignementsGenerauxUseCaseProvider, saveRenseignementsGenerauxUseCaseProvider, load, missionId, ref, RenseignementsGenerauxNotifier, updateField, _sendEmailWithAttachment (+1 more)

### Community 122 - "pdf_statistics_charts.dart"
Cohesion: 0.08
Nodes (23): Font get, axisBlack, buildBtCategoryStackedBarChart, buildBtParafoudreStackedBarChart, buildBtSourceStackedBarChart, buildDisjoncteurTeteDonutChart, buildEquipmentCategoryStackedBarChart, buildMtCategoryStackedBarChart (+15 more)
...
### Community 124 - "pdf_statistics_builder.dart"
Cohesion: 0.08
Nodes (23): buildAnalyseStatistique, _buildBt2ColumnTable, _buildBtCoupureTable, _buildBtParafoudreTable, _buildBtSourceTable, _buildCalloutBox, _buildCrossAuditTable, _buildDynamicParetoExplanation (+15 more)
...
Cohesion: 0.08
Nodes (25): createdAt, data, InstallationItemEntity, photoPaths, build, _buildListTile, _buildRadioTile, _buildSimpleTile (+17 more)
...
Cohesion: 0.10
Nodes (20): build, createState, dispose, _emailController, _errorMessage, _formKey, _isLoading, _isLocked (+12 more)
...
### Community 136 - "MaterialPageRoute"
Cohesion: 0.06
Nodes (33): _allerAuClassement, _ajouterCoffret, _ajouterObservation, _allerAuClassement, _editerCoffret, _editerCoffretByIndex, _editerLocal, _editerObservation (+25 more)
...
### Community 140 - "int get"
Cohesion: 0.07
Nodes (26): hashCode, operator, read, typeId, write, hashCode, operator, read (+18 more)
...
### Community 146 - "microsoft_user_profile.dart"
Cohesion: 0.22
Nodes (8): displayName, email, fromJson, id, jobTitle, MicrosoftUserProfile, officeLocation, toJson
...
### Community 151 - "status_action_button.dart"
Cohesion: 0.15
...
### Community 155 - "package:inspec_app/components/safe_file_image.dart"
Cohesion: 0.17
...
### Community 156 - "essai_declenchement_helper.dart"
Cohesion: 0.17
...
Cohesion: 0.10
Nodes (20): AddNonConformingLuminaireSheet, _AddNonConformingLuminaireSheetState, _answers, _areAllCurrentSlideElementsAnswered, build, _buildQuestionCardItem, _commentControllers, createState (+12 more)
...
### Community 162 - "jsa_provider.dart"
Cohesion: 0.09
Nodes (26): ../entities/jsa_entity.dart, getCurrentUserUseCaseProvider, getJsaByMissionUseCaseProvider, saveJsaUseCaseProvider, JsaRepositoryImpl, getOrCreateJSA, JsaRepository, saveJSA (+18 more)

### Community 163 - "package:inspec_app/models/mission.dart"
Cohesion: 0.04
Nodes (52): FixedColumnWidth, RenseignementsGenerauxMapper, toEntity, toModel, ensureCurrentUserInJSA, getMissionIntervenants, getMissionIntervenantsNoms, IntervenantsService (+44 more)
...
Cohesion: 0.04
Nodes (44): _addCoffretObservations, _buildListeRecapitulativeMulti, _buildObsRecapTableBT, _buildObsRecapTableBTFromGroups, _buildObsRecapTableMT, _buildObsRecapTableUnifie, buildObsRecapTableUnifieForTesting, coffret (+36 more)
...
### Community 173 - "mission_local_data_source.dart"
Cohesion: 0.11
Nodes (17): addDocumentPersonnalise, getAllReportsForMission, getMissionById, getMissionsByMatricule, _missionBox, MissionLocalDataSource, MissionLocalDataSourceImpl, removeDocumentPersonnalise (+9 more)
...
### Community 175 - "sauvegardes_screen.dart"
Cohesion: 0.09
...
### Community 176 - "distribution_item_widget.dart"
Cohesion: 0.12
Nodes (13): build, completedMissions, inProgressMissions, pendingMissions, StatsGrid, totalMissions, build, color (+5 more)

### Community 177 - "List"
Cohesion: 0.09
Nodes (19): double?, backups, build, _buildBackupCard, isLoading, onRefresh, RecentBackupsList, build (+11 more)
...
Cohesion: 0.09
Nodes (21): ../datasources/foudre_local_data_source.dart, ../../domain/entities/foudre_entity.dart, ../../domain/repositories/foudre_repository.dart, _box, createFoudreObservation, deleteFoudreObservation, _foudreBox, FoudreLocalDataSource (+13 more)
...
### Community 183 - "demarrage_auto_screen.dart"
Cohesion: 0.15
...
### Community 188 - "cancellation_token.dart"
Cohesion: 0.15
...
Cohesion: 0.08
Nodes (23): bool get, BackupCancelToken, cancel, _isCancelled, message, onCancel, _reason, throwIfCancelled (+15 more)
...
### Community 195 - "FoudreRepository"
Cohesion: 0.12
Nodes (16): ../entities/foudre_entity.dart, FoudreRepositoryImpl, createFoudreObservation, deleteFoudreObservation, FoudreRepository, getFoudreObservationsByMissionId, updateFoudreObservation, call (+8 more)
...
### Community 198 - "home_app_bar.dart"
Cohesion: 0.14
...
### Community 201 - "mesuresEssaisProvider"
Cohesion: 0.07
...
### Community 202 - "pdf_photos_deduplication_test.dart"
Cohesion: 0.11
Nodes (18): RenseignementsGenerauxAdapter, getOrCreateRenseignementsGeneraux, _missionBox, _renseignementsGenerauxBox, RenseignementsGenerauxLocalDataSource, RenseignementsGenerauxLocalDataSourceImpl, saveRenseignementsGeneraux, RenseignementsGeneraux (+10 more)
...
### Community 205 - "package:flutter/foundation.dart"
Cohesion: 0.06
Nodes (32): isKnown, _noneOptions, _normalize, resolve, SourceStatusResolver, statusConnue, statusInconnue, _validProtectionTypes (+24 more)

### Community 206 - "package:flutter_riverpod/flutter_riverpod.dart"
Cohesion: 0.09
Nodes (27): AuditInstallationsRepository get, Completer, Future, getAuditInstallationsUseCaseProvider, saveAuditInstallationsUseCaseProvider, AuditInstallationsElectriquesEntity, GetAuditInstallationsUseCase, SaveAuditInstallationsUseCase (+19 more)

### Community 207 - "package:path_provider/path_provider.dart"
Cohesion: 0.33
...
### Community 208 - "pdf_footer_builder.dart"
Cohesion: 0.10
...
### Community 211 - "microsoft_account_header.dart"
Cohesion: 0.15
...
### Community 212 - "mission_execution.dart"
Cohesion: 0.14
...
### Community 213 - "mission_detail_provider.dart"
Cohesion: 0.15
...
### Community 220 - "package:inspec_app/constants/app_theme.dart"
Cohesion: 0.07
...
### Community 235 - "local_backup_store.dart"
Cohesion: 0.08
...
### Community 238 - "mesures_essais_repository_impl.dart"
Cohesion: 0.17
...
### Community 240 - "description_installations_local_data_source.dart"
Cohesion: 0.20
...
### Community 243 - "canonical_defect_category_registry.dart"
Cohesion: 0.15
...
### Community 246 - "pdf_chunk_merger.dart"
Cohesion: 0.15
...
Cohesion: 0.06
Nodes (52): @HiveType, AlimentationAdapter, BasseTensionLocalAdapter, BasseTensionZoneAdapter, CelluleAdapter, CircuitTerminalEquipementAdapter, DepartEquipementAdapter, ElementControleAdapter (+44 more)
...
### Community 259 - "status_selector_modal.dart"
Cohesion: 0.18
Nodes (10): _availableStatuses, build, createState, _getStatusColor, initState, _isUpdating, mission, _normalizeStatus (+2 more)

### Community 261 - "package:flutter/material.dart"
Cohesion: 0.06
Nodes (30): build, confirmText, LocalDeletionWarningDialog, message, onConfirm, show, title, createState (+22 more)

### Community 262 - "verificateur_entity.dart"
Cohesion: 0.20
Nodes (9): createdAt, email, fullName, id, matricule, nom, password, prenom (+1 more)

### Community 265 - "mesures_essais_local_data_source.dart"
Cohesion: 0.22
Nodes (9): Box, _box, getOrCreateMesuresEssais, _mBox, _mesuresEssaisBox, MesuresEssaisLocalDataSource, MesuresEssaisLocalDataSourceImpl, _missionBox (+1 more)

### Community 267 - "backup_job_store.dart"
Cohesion: 0.20
...
### Community 277 - "MockPlatformInterfaceMixin"
Cohesion: 0.36
...
### Community 278 - "static const Map"
Cohesion: 0.25
...
### Community 279 - "stats_status_distribution.dart"
Cohesion: 0.25
...
### Community 283 - "mission_status_badge.dart"
Cohesion: 0.29
Nodes (6): build, _getStatusColor, _getStatusIcon, MissionStatusBadge, _normalizeStatus, status

### Community 284 - "ConsumerState"
Cohesion: 0.16
Nodes (18): ConsumerState, ConsumerStatefulWidget, MsalRecommendationBanner, _MsalRecommendationBannerState, AjouterCoffretScreen, _AjouterCoffretScreenState, AjouterEssaiDeclenchementScreen, _AjouterEssaiDeclenchementScreenState (+10 more)

### Community 285 - "../../models/audit_installations_electriques.dart"
Cohesion: 0.29
...
### Community 291 - "StatisticalSynthesisBlock"
Cohesion: 0.67
Nodes (3): _buildStandardNarrativeResult, StatisticalSynthesisBlock, StatisticalSynthesisEngine

## Knowledge Gaps
- **7315 isolated node(s):** `XCTest`, `queryText`, `equipmentType`, `selectedReferenceNormative`, `selectedFamilleRisque` (+7310 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 7630 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **22 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Mission` connect `package:inspec_app/constants/app_theme.dart` to `hive_service.dart`, `ajouter_local_screen.dart`, `ajouter_coffret_screen.dart`, `mission_card.dart`, `avis_mesures_screen.dart`, `foudre_screen.dart`, `installation_detail.dart`, `status_selector_modal.dart`, `mesures_essais_local_data_source.dart`, `package:flutter/material.dart`, `backup_service.dart`, `pdf_schema_section_test.dart`, `essais_declenchement_screen.dart`, `jsa_step.dart`, `alimentation_site_mt_sequence_screen.dart`, `description_installations_form.dart`, `general_info_step.dart`, `sequence_screen.dart`, `detail_zone_screen.dart`, `mission.dart`, `lighting_mission_detail_screen.dart`, `detail_coffret_screen.dart`, `detail_local_screen.dart`, `status_action_button.dart`, `mesures_essais_screen.dart`, `package:inspec_app/services/hive_service.dart`, `audit_installations.dart`, `moyenne_tension_screen.dart`, `essais_isolement_screen.dart`, `package:inspec_app/models/mission.dart`, `cpi_sequence_screen.dart`, `summary_step.dart`, `mission_analytics_detail_screen.dart`, `mission_local_data_source.dart`, `ajouter_zone_screen.dart`, `classement_emplacement_screen.dart`, `foudre_local_data_source.dart`, `jsa_local_data_source.dart`, `basse_tension_screen.dart`, `demarrage_auto_screen.dart`, `qr_scan_coffret_screen.dart`, `jsa_standalone_screen.dart`, `mission_hub_screen.dart`, `description_installations_sequence.dart`, `prises_terre_screen.dart`, `schema_step.dart`, `cpi_tests_list_screen.dart`, `lighting_summary_screen.dart`, `continuite_resistance_screen.dart`, `create_mission_screen.dart`, `descriptionInstallationsProvider`, `mesuresEssaisProvider`, `pdf_photos_deduplication_test.dart`, `mission_detail_screen.dart`, `pdf_report_context.dart`, `mission_execution.dart`, `classement_zone_screen.dart`, `mission_team_section.dart`, `radio_sequence_screen.dart`, `radio_selection_screen.dart`, `arret_urgence_screen.dart`, `mission_backup_card.dart`, `client_logo_screen.dart`, `item_detail_screen.dart`, `cpi_test_form_screen.dart`, `ajouter_foudre_screen.dart`, `@HiveType`, `description_step.dart`, `paratonnerre_screen.dart`, `description_installations_screen/description_installations.dart`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `MesuresEssaisLocalDataSource` connect `mesures_essais_local_data_source.dart` to `mesures_essais_repository_impl.dart`, `injection_container.dart`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `VerificateurRepository` connect `main.dart` to `mission_local_data_source.dart`, `injection_container.dart`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **What connects `XCTest`, `queryText`, `equipmentType` to the rest of the system?**
  _7315 weakly-connected nodes found - possible documentation gaps or missing edges._

# Graph Report - inspection_app  (2026-09-08)

## Corpus Check
- 470 files · ~496,101 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8356 nodes · 11591 edges · 281 communities (238 shown, 31 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `48958fd8`
...
- renseignements_generaux_provider.dart
...
1. `Mission` - 87 edges
2. `mesuresEssaisProvider` - 38 edges
3. `descriptionInstallationsProvider` - 34 edges
4. `AuditInstallationsElectriques` - 21 edges
5. `Verificateur` - 18 edges
6. `class` - 17 edges
7. `Foudre` - 14 edges
8. `Global Constraints` - 14 edges
9. `MissionRepository` - 13 edges
10. `DescriptionInstallations` - 13 edges
...
## Communities (281 total, 31 thin omitted)

### Community 0 - "hive_service.dart"
Cohesion: 0.00
Nodes (476): equipment_number_service.dart, installation_description_sync_service.dart, int? zoneIndex,
  bool, ip_ik_evaluator_service.dart, add, addAccompagnateur, addBasseTensionZone, addCarteToSection (+468 more)
...
Cohesion: 0.01
Nodes (301): _accessible, addObservation, _ajouterCellule, _ajouterObservation, _ajouterTransformateur, _annulerEdition, _autoSaveTimer, _baseUrl (+293 more)

### Community 3 - "ajouter_coffret_screen.dart"
Cohesion: 0.01
Nodes (278): _accessible, _addCoffretToLocalInMoyenneTensionZone, addObservation, _addObservationToPoint, _addParafoudreObservation, _addSortieInverseur, _ajouterAutrePoint, _ajouterObservation (+270 more)

### Community 4 - "audit_installations_electriques.dart"
Cohesion: 0.01
Nodes (153): hashCode, operator, read, typeId, write, Cellule? get, accessible, addPhoto (+145 more)
...
Cohesion: 0.03
Nodes (80): AuditInstallationsElectriquesAdapter, FoudreAdapter, toEntity, toModel, VerificateurMapper, FoudreMapper, toEntity, toModel (+72 more)

### Community 7 - "audit_installations_entities.dart"
Cohesion: 0.02
Nodes (117): ../core/utils/source_status_resolver.dart, accessible, AlimentationEntity, alimentations, alimenteeParTransformateur, annee, anneeFabrication, aReverifier (+109 more)

### Community 8 - "package:flutter_test/flutter_test.dart"
Cohesion: 0.03
Nodes (61): Column, Container, package:flutter_test/flutter_test.dart, package:inspec_app/core/utils/source_status_resolver.dart, package:inspec_app/features/audit_installations/data/mappers/audit_installations_mapper.dart, package:inspec_app/features/audit_installations/domain/entities/audit_installations_entities.dart, package:inspec_app/models/audit_installations_electriques.dart, package:inspec_app/services/cellule_types_registry.dart (+53 more)
...
Cohesion: 0.02
Nodes (90): AvisMesuresTerreAdapter, ConditionMesureAdapter, hashCode, operator, read, typeId, write, appreciation (+82 more)
...
Cohesion: 0.03
Nodes (76): appreciation, avisMesuresTerre, AvisMesuresTerreEntity, calibre, coffret, conditionMesure, ConditionMesureEntity, conditionPriseTerre (+68 more)

### Community 19 - "sequence_screen.dart"
Cohesion: 0.03
Nodes (62): _animCtrl, _auditProgress, _blockMessage, build, _buildDrawer, _buildDrawerHeader, _buildDrawerItem, _buildNavButtons (+54 more)
...
Cohesion: 0.09
Nodes (21): package:crypto/crypto.dart, package:flutter/services.dart, package:inspec_app/features/backup/data/datasources/backup_job_store.dart, package:inspec_app/features/backup/data/datasources/local_backup_store.dart, package:inspec_app/features/backup/data/services/backup_job_manager.dart, package:inspec_app/features/backup/data/services/mission_activity_tracker.dart, package:inspec_app/features/backup/domain/models/backup_cancel_token.dart, package:inspec_app/features/backup/domain/models/backup_job.dart (+13 more)

### Community 25 - "mesures_essais_screen.dart"
Cohesion: 0.07
...
Cohesion: 0.04
Nodes (72): Color, IconData, MyApp, AnalyticsKpiCards, build, _buildKpiCard, data, isDarkMode (+64 more)

### Community 30 - "State"
Cohesion: 0.06
Nodes (45): _EtapeInformationsGenerales, AddNonConformingLuminaireSheet, _AddNonConformingLuminaireSheetState, LightingInspectionFormScreen, _LightingInspectionFormScreenState, _EquipmentSourceAutocompleteField, _EquipmentSourceAutocompleteFieldState, _EtapeAlimentations (+37 more)
...
Cohesion: 0.05
Nodes (46): ../datasources/backup_job_store.dart, ../datasources/local_backup_store.dart, ../datasources/microsoft_auth_service.dart, ../datasources/microsoft_graph_storage_service.dart, ../../domain/models/cloud_backup_manifest.dart, ../../domain/repositories/backup_sync_repository.dart, MicrosoftGraphStorageService, authService (+38 more)
...
Cohesion: 0.06
Nodes (38): AsyncValue, ../../data/datasources/backup_job_store.dart, ../../data/datasources/backup_queue_service.dart, ../../data/datasources/microsoft_auth_service.dart, ../../data/datasources/microsoft_graph_storage_service.dart, ../../data/repositories/backup_sync_repository_impl.dart, ../../data/services/app_update_migration_service.dart, ../../data/services/backup_job_manager.dart (+30 more)
...
Cohesion: 0.05
Nodes (49): descriptionInstallationsProvider, AlimentationSiteMtSequenceScreen, _AlimentationSiteMtSequenceScreenState, build, _buildSectionCard, createState, dispose, _iacmOptions (+41 more)
...
### Community 80 - "MaterialPageRoute"
Cohesion: 0.06
Nodes (34): _sauvegarder, _allerAuClassement, _ajouterObservation, _editerCoffret, _editerObservation, _ajouterCoffret, _ajouterObservation, _allerAuClassement (+26 more)
...
Cohesion: 0.06
Nodes (34): build, equipmentType, isAutoLinked, NormativeSearchSuggestionsWidget, onSelect, onUnlink, queryText, selectedCriticite (+26 more)
...
### Community 87 - "static const double"
Cohesion: 0.22
...
Cohesion: 0.05
Nodes (37): ../datasources/audit_installations_local_data_source.dart, ../../domain/entities/audit_installations_entities.dart, ../../domain/repositories/audit_installations_repository.dart, AuditInstallationsLocalDataSource, AuditInstallationsLocalDataSourceImpl, getOrCreateAuditInstallations, saveAuditInstallations, AuditInstallationsMapper (+29 more)
...
### Community 93 - "renseignements_generaux_provider.dart"
Cohesion: 0.09
Nodes (26): getCurrentUserUseCaseProvider, getJsaByMissionUseCaseProvider, saveJsaUseCaseProvider, getRenseignementsGenerauxUseCaseProvider, saveRenseignementsGenerauxUseCaseProvider, JsaNotifier, load, missionId (+18 more)
...
### Community 98 - "executive_summary_snapshot.dart"
Cohesion: 0.08
...
### Community 99 - "backup_job_store.dart"
Cohesion: 0.08
Nodes (21): ../../domain/models/backup_job.dart, ../../domain/models/backup_preferences.dart, BackupJobStore, _boxName, deleteJob, getActiveJobForMission, _getBox, getIncompleteJobs (+13 more)

### Community 100 - "String get"
Cohesion: 0.13
...
### Community 101 - "conditions_mesure_screen.dart"
Cohesion: 0.14
...
Cohesion: 0.09
Nodes (22): build, champs, _controllers, createState, _deleteItem, dispose, index, _initializeControllers (+14 more)

### Community 106 - "package:flutter/foundation.dart"
Cohesion: 0.13
Nodes (12): MissionIntegrityValidator, sanitizeSequenceProgress, clear, isBusy, PersistenceQueue, _queues, migrateExistingUsers, MigrationHelper (+4 more)
...
### Community 108 - "observation_enrichie_widget.dart"
Cohesion: 0.05
Nodes (36): ImagePicker, _answers, _areAllCurrentSlideElementsAnswered, build, _buildQuestionCardItem, _commentControllers, createState, _currentStep (+28 more)
...
Cohesion: 0.06
Nodes (33): @pragma, ../datasources/backup_queue_service.dart, ../../domain/models/backup_queue_item.dart, BackupQueueService, _boxName, clearQueue, enqueueOrUpdate, _getBox (+25 more)

### Community 112 - "List"
Cohesion: 0.12
Nodes (15): build, createState, initState, _isLoading, _isSaving, _loadData, mission, _options (+7 more)

### Community 113 - "microsoft_graph_storage_service.dart"
Cohesion: 0.09
...
### Community 114 - "mission_backup_card.dart"
Cohesion: 0.10
Nodes (25): ConsumerWidget, ../../data/services/backup_orchestrator.dart, ../../domain/models/mission_sync_state.dart, backupOrchestratorStateProvider, backupQueueServiceProvider, backupSyncNotifierProvider, build, _refresh (+17 more)

### Community 115 - "pdf_mesures_essais_builder.dart"
Cohesion: 0.03
Nodes (64): PointEquipmentInfo, accentColor, addMesuresEssaisPages, armoireGroups, armoireName, _bodyBold, _bodyText, borderColor (+56 more)

### Community 116 - "installation_detail.dart"
Cohesion: 0.11
...
### Community 120 - "renseignements_generaux_repository_impl.dart"
Cohesion: 0.17
...
### Community 123 - "package:inspec_app/models/description_installations.dart"
Cohesion: 0.10
Nodes (17): package:inspec_app/features/description_installations/data/mappers/description_installations_mapper.dart, package:inspec_app/features/description_installations/domain/entities/description_installations_entity.dart, package:inspec_app/features/description_installations/domain/entities/installation_item_entity.dart, package:inspec_app/models/description_installations.dart, package:inspec_app/models/pdf/installation_description_pdf_data.dart, package:inspec_app/services/installation_description_sync_service.dart, main, main (+9 more)

### Community 124 - "description_step.dart"
Cohesion: 0.13
Nodes (14): GlobalKey, build, createState, initState, isFirstSlide, isLastSlide, jumpToSection, mission (+6 more)

### Community 125 - "get_audit_installations_use_case.dart"
Cohesion: 0.19
...
### Community 126 - "mesures_essais_provider.dart"
Cohesion: 0.09
...
Cohesion: 0.08
Nodes (23): dart:io, package:archive/archive_io.dart, package:inspec_app/services/ai/executive_summary_snapshot.dart, package:inspec_app/services/ai/mission_executive_summary_service.dart, package:inspec_app/services/backup/backup_format_strategy.dart, package:inspec_app/services/pdf/builders/pdf_audit_installations_builder.dart, package:inspec_app/services/pdf/builders/pdf_cover_builder.dart, package:inspec_app/services/pdf/builders/pdf_equipements_synthesis_builder.dart (+15 more)
...
### Community 136 - "renseignements_generaux_test.dart"
Cohesion: 0.12
...
Cohesion: 0.09
Nodes (21): coffretPointTitle, conformite, evaluate, _findLocationForCoffret, formatFromDigits, hashCode, hasIpOrIk, ik (+13 more)
...
### Community 142 - "ajouter_foudre_screen.dart"
Cohesion: 0.11
...
### Community 143 - "cpi_sequence_screen.dart"
Cohesion: 0.12
...
Cohesion: 0.07
Nodes (25): build, _buildBadge, onCancel, onClose, OperationProgressDialog, state, copyWith, currentMissionIndex (+17 more)

### Community 146 - "mesures_essais_local_data_source.dart"
Cohesion: 0.22
...
### Community 148 - "mesuresEssaisProvider"
Cohesion: 0.07
Nodes (39): ConsumerState, ConsumerStatefulWidget, mesuresEssaisProvider, AjouterCoffretScreen, _AjouterCoffretScreenState, _transfererEssais, AjouterContinuiteResistanceScreen, _AjouterContinuiteResistanceScreenState (+31 more)

### Community 150 - "lighting_mission_detail_screen.dart"
Cohesion: 0.11
...
### Community 152 - "source_status_resolver.dart"
Cohesion: 0.20
...
Cohesion: 0.04
Nodes (50): Font get, accentColor, addPhotosSectionChunked, addSchemaSection, badgeBgColor, badgeLabel, badgeTextColor, borderColor (+42 more)
...
### Community 155 - "msal_recommendation_banner.dart"
Cohesion: 0.32
...
### Community 156 - "recent_backups_list.dart"
Cohesion: 0.25
...
### Community 158 - "mission_team_section.dart"
Cohesion: 0.12
...
### Community 160 - "equipment_number_service.dart"
Cohesion: 0.12
...
### Community 162 - "sidebar_menu.dart"
Cohesion: 0.11
...
Cohesion: 0.05
Nodes (40): Font, buildCoverPage, buildIntervenantsEtResponsabilitesPage, cachedClientLogoImg, cachedClientQrImg, coverInfoRow, docStatus, fontBold (+32 more)
...
### Community 165 - "package:pdf/widgets.dart"
Cohesion: 0.07
Nodes (28): _buildContactItem, buildFirstPageFooter, buildOtherPageFooter, _buildVectorIcon, darkSlateGrey, headerGrey, kesBlue, kFullPageWidth (+20 more)

### Community 166 - ".application"
Cohesion: 0.15
Nodes (10): Any, Flutter, FlutterAppDelegate, AppDelegate, Bool, RunnerTests, UIApplication, UIKit (+2 more)

### Community 167 - "package:hive/hive.dart"
Cohesion: 0.06
Nodes (35): @Timeout, DescriptionInstallationsAdapter, hashCode, operator, read, typeId, write, Directory (+27 more)

### Community 168 - "date_selector_widget.dart"
Cohesion: 0.25
Nodes (7): build, DateSelectorWidget, firstDate, _formatDate, label, lastDate, selectedDate

### Community 169 - "renseignements_generaux_local_data_source.dart"
Cohesion: 0.33
...
Cohesion: 0.08
Nodes (23): displayName, email, fromJson, id, jobTitle, MicrosoftUserProfile, officeLocation, toJson (+15 more)

### Community 174 - "@visibleForTesting"
Cohesion: 0.11
Nodes (19): @visibleForTesting, testParseCoffrets, testSerializeCoffret, buildPhotoNumberRegistryForTest, formatPhotoNumbersForTest, buildEquipementsTableForTesting, buildObsRecapTableUnifieForTesting, buildPhotoNumberRegistryForTest (+11 more)

### Community 175 - "int get"
Cohesion: 0.15
Nodes (13): hashCode, LastReportAdapter, operator, read, typeId, write, int get, fileName (+5 more)

### Community 176 - "sort_dialog.dart"
Cohesion: 0.06
...
### Community 177 - "cancellation_token.dart"
Cohesion: 0.15
...
### Community 180 - "app_bottom_sheet.dart"
Cohesion: 0.25
...
Cohesion: 0.06
Nodes (27): btRows, _collectAllCellules, _collectAllTransformateurs, _createRowFromCellule, _createRowFromCelluleAndItem, _createRowFromItemOnly, _createRowFromTransformateur, _createRowFromTransformateurAndItem (+19 more)
...
Cohesion: 0.05
Nodes (41): _buildAlimentationSiteMtTable, _buildAuditContentOrdered, _buildCelluleSection, _buildCoffret, _buildCpiTable, _buildCpiTestContent, _buildDispositionsTable, _buildLocalBT (+33 more)
...
### Community 190 - "static const String"
Cohesion: 0.12
...
### Community 195 - "pdf_chunk_merger.dart"
Cohesion: 0.18
...
Cohesion: 0.05
Nodes (39): accessible, alimentationConcernee, _buildEquipementsTable, buildEquipementsTableForTesting, _buildUnknownSourcesTable, _collectEquipementsBT, _collectEquipementsMT, _collectEquipementsUnknownSource (+31 more)

### Community 198 - "../../models/audit_installations_electriques.dart"
Cohesion: 0.12
...
### Community 199 - "verificateur_entity.dart"
Cohesion: 0.20
Nodes (9): createdAt, email, fullName, id, matricule, nom, password, prenom (+1 more)

### Community 201 - "description_installations_provider.dart"
Cohesion: 0.15
...
### Community 202 - "search_dialog.dart"
Cohesion: 0.20
...
### Community 204 - "mission_status_badge.dart"
Cohesion: 0.29
Nodes (6): build, _getStatusColor, _getStatusIcon, MissionStatusBadge, _normalizeStatus, status

### Community 205 - "Map"
Cohesion: 0.33
Nodes (5): createdAt, data, InstallationItemEntity, photoPaths, Map

### Community 207 - "pdf_statistics_builder.dart"
Cohesion: 0.07
Nodes (26): buildAnalyseStatistique, _buildBarChart, _buildBulletItem, _buildCategoryParetoChartWidget, _buildCrossCategorySection, _buildGlossaireCell, _buildIndicateurRow, _buildMultiLineValueWidget (+18 more)

### Community 208 - "pdf_description_builder.dart"
Cohesion: 0.08
...
### Community 211 - "mission_detail_provider.dart"
Cohesion: 0.15
...
### Community 212 - "pdf_executive_summary_builder.dart"
Cohesion: 0.10
Nodes (20): _buildCriticalitySummaryTable, _buildFormattedText, _buildGroupedCellWidget, _buildIndicateurRow, buildResumeExecutif, _buildRiskFactorsSummaryTable, _buildTableCell, _buildTableHeaderCell (+12 more)

### Community 213 - "GeneralInfoStepState"
Cohesion: 0.40
...
### Community 218 - "stats_status_distribution.dart"
Cohesion: 0.12
...
### Community 220 - "auth_local_data_source.dart"
Cohesion: 0.12
...
### Community 226 - "stats_app_bar.dart"
Cohesion: 0.25
...
### Community 235 - "canonical_defect_category_registry.dart"
Cohesion: 0.15
...
### Community 243 - "local_backup_store.dart"
Cohesion: 0.20
...
### Community 246 - "package:inspec_app/models/mesures_essais.dart"
Cohesion: 0.14
Nodes (10): package:inspec_app/features/mesures_essais/data/mappers/mesures_essais_mapper.dart, package:inspec_app/features/mesures_essais/domain/entities/mesures_essais_entities.dart, package:inspec_app/models/mesures_essais.dart, main, tempDir, main, main, main (+2 more)
...
Cohesion: 0.06
Nodes (47): @HiveType, AlimentationAdapter, BasseTensionLocalAdapter, BasseTensionZoneAdapter, CelluleAdapter, CircuitTerminalEquipementAdapter, CoffretArmoireAdapter, ElementControleAdapter (+39 more)

### Community 251 - "package:flutter_riverpod/flutter_riverpod.dart"
Cohesion: 0.11
Nodes (24): AuditInstallationsRepository get, Completer, getAuditInstallationsUseCaseProvider, saveAuditInstallationsUseCaseProvider, AuditInstallationsElectriquesEntity, GetAuditInstallationsUseCase, SaveAuditInstallationsUseCase, AuditInstallationsNotifier (+16 more)
...
### Community 261 - "getDescriptionInstallationsUseCaseProvider"
Cohesion: 0.29
...
### Community 262 - "package:path_provider/path_provider.dart"
Cohesion: 0.33
...
### Community 263 - "_ForgotPasswordScreenState"
Cohesion: 0.29
...
## Knowledge Gaps
- **6532 isolated node(s):** `XCTest`, `queryText`, `equipmentType`, `selectedReferenceNormative`, `selectedFamilleRisque` (+6527 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 6822 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **31 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Mission` connect `package:inspec_app/models/mission.dart` to `hive_service.dart`, `ajouter_local_screen.dart`, `ajouter_coffret_screen.dart`, `mission_card.dart`, `avis_mesures_screen.dart`, `foudre_screen.dart`, `mission_local_data_source.dart`, `backup_service.dart`, `pdf_photos_deduplication_test.dart`, `essais_declenchement_screen.dart`, `ajouter_foudre_screen.dart`, `cpi_sequence_screen.dart`, `general_info_step.dart`, `description_installations_form.dart`, `mesures_essais_local_data_source.dart`, `sequence_screen.dart`, `detail_zone_screen.dart`, `mission.dart`, `lighting_mission_detail_screen.dart`, `detail_coffret_screen.dart`, `detail_local_screen.dart`, `mesures_essais_screen.dart`, `paratonnerre_screen.dart`, `package:inspec_app/services/hive_service.dart`, `audit_installations.dart`, `mission_team_section.dart`, `package:flutter/material.dart`, `moyenne_tension_screen.dart`, `essais_isolement_screen.dart`, `pdf_schema_section_test.dart`, `package:hive/hive.dart`, `renseignements_generaux_local_data_source.dart`, `summary_step.dart`, `mission_analytics_detail_screen.dart`, `ajouter_zone_screen.dart`, `String?`, `classement_emplacement_screen.dart`, `foudre_local_data_source.dart`, `basse_tension_screen.dart`, `status_action_button.dart`, `qr_scan_coffret_screen.dart`, `jsa_standalone_screen.dart`, `mission_hub_screen.dart`, `lighting_inspection.dart`, `description_installations_sequence.dart`, `prises_terre_screen.dart`, `schema_step.dart`, `cpi_tests_list_screen.dart`, `lighting_summary_screen.dart`, `continuite_resistance_screen.dart`, `create_mission_screen.dart`, `descriptionInstallationsProvider`, `mission_detail_screen.dart`, `jsa_step.dart`, `pdf_report_context.dart`, `classement_zone_screen.dart`, `radio_sequence_screen.dart`, `radio_selection_screen.dart`, `status_selector_modal.dart`, `conditions_mesure_screen.dart`, `client_logo_screen.dart`, `item_detail_screen.dart`, `cpi_test_form_screen.dart`, `List`, `mission_backup_card.dart`, `installation_detail.dart`, `@HiveType`, `description_step.dart`, `description_installations_screen/description_installations.dart`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `GetFoudreObservationsUseCase` connect `foudre_providers.dart` to `injection_container.dart`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `Verificateur` connect `verificateur.dart` to `hive_service.dart`, `backup_screen.dart`, `sidebar_menu.dart`, `mission_card.dart`, `home_screen.dart`, `pdf_photos_deduplication_test.dart`, `create_mission_screen.dart`, `pdf_schema_section_test.dart`, `mission_detail_screen.dart`, `summary_step.dart`, `stats_screen.dart`, `lighting_inspection.dart`, `sequence_screen.dart`, `@HiveType`, `mission_hub_screen.dart`, `auth_local_data_source.dart`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **What connects `XCTest`, `queryText`, `equipmentType` to the rest of the system?**
  _6532 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `ajouter_local_screen.dart` be split into smaller, more focused modules?**
  _Cohesion score 0.006622516556291391 - nodes in this community are weakly interconnected._
# Graph Report - inspection_app  (2026-09-09)

## Corpus Check
- 477 files · ~505,741 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8491 nodes · 11767 edges · 282 communities (242 shown, 28 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6fc5be8c`
...
- mission_team_traceability_card.dart
...
Cohesion: 0.00
Nodes (481): equipment_number_service.dart, int? zoneIndex,
  bool, ip_ik_evaluator_service.dart, add, addAccompagnateur, addBasseTensionZone, addCarteToSection, addCelluleItem (+473 more)

### Community 1 - "pdf_report_service.dart"
Cohesion: 0.02
Nodes (137): ../ai/executive_summary_data.dart, ../ai/executive_summary_snapshot.dart, ../ai/mission_executive_summary_service.dart, @visibleForTesting, builders/pdf_cover_builder.dart, builders/pdf_executive_summary_builder.dart, builders/pdf_regulatory_builder.dart, builders/pdf_sommaire_builder.dart (+129 more)
...
Cohesion: 0.03
Nodes (77): FoudreAdapter, toEntity, toModel, VerificateurMapper, FoudreMapper, toEntity, toModel, call (+69 more)
...
Cohesion: 0.02
Nodes (102): AvisMesuresTerreAdapter, EssaiDeclenchementDifferentielAdapter, EssaiDemarrageAutoAdapter, EssaiIsolementAdapter, hashCode, operator, PriseTerreAdapter, read (+94 more)
...
Cohesion: 0.03
Nodes (82): _allerAuClassement, _editerCoffret, _ajouterCoffret, _ajouterObservation, _allerAuClassement, _editerCoffret, _editerCoffretByIndex, _editerLocal (+74 more)
...
Cohesion: 0.05
Nodes (58): @Timeout, DescriptionInstallationsAdapter, dart:io, Directory, DescriptionInstallations, package:archive/archive_io.dart, package:crypto/crypto.dart, package:flutter/services.dart (+50 more)

### Community 25 - "pdf_schema_section_test.dart"
Cohesion: 0.06
...
Cohesion: 0.05
Nodes (43): MyApp, InvalidFormatDialog, MissionHeader, AnalyticsKpiCards, build, _buildKpiCard, data, isDarkMode (+35 more)
...
### Community 35 - "class"
Cohesion: 0.08
Nodes (31): getCurrentUserUseCaseProvider, getJsaByMissionUseCaseProvider, saveJsaUseCaseProvider, saveRenseignementsGenerauxUseCaseProvider, GetJsaByMissionUseCase, SaveJsaUseCase, JsaNotifier, load (+23 more)

### Community 36 - "home_screen.dart"
Cohesion: 0.04
Nodes (45): _applyFilters, build, _buildCurrentPageContent, _buildHomeContent, _buildKpiChip, _buildQuickIconButton, _buildSearchBar, createState (+37 more)
...
Cohesion: 0.04
Nodes (50): getAllReportsForMissionUseCaseProvider, getRenseignementsGenerauxUseCaseProvider, saveLastReportUseCaseProvider, updateMissionStatusUseCaseProvider, updateMissionStatus, _buildBottomNavigation, _buildCircleActionButton, _buildGenerateButton (+42 more)
...
### Community 54 - "package:pdf/widgets.dart"
Cohesion: 0.07
Nodes (32): Column, Container, NewPage, package:inspec_app/services/cancellation_token.dart, package:inspec_app/services/pdf/builders/pdf_audit_installations_builder.dart, package:inspec_app/services/pdf/builders/pdf_classement_foudre_builder.dart, package:inspec_app/services/pdf/builders/pdf_cover_builder.dart, package:inspec_app/services/pdf/builders/pdf_description_builder.dart (+24 more)
...
Cohesion: 0.06
Nodes (33): _ajouterPriseTerre, build, _buildDropdown, _buildInfoRow, _buildTextField, _conditionMesure, _conditionOptions, createState (+25 more)
...
Cohesion: 0.14
Nodes (17): missionDetailProvider, _ajouterDocumentPersonnalise, build, _buildDocumentTile, createState, dispose, _documentsStandards, DocumentsStep (+9 more)
...
### Community 80 - "installation_description_pdf_data.dart"
Cohesion: 0.10
...
Cohesion: 0.06
Nodes (43): AsyncValue, AuditInstallationsRepository get, Completer, Future, getAuditInstallationsUseCaseProvider, saveAuditInstallationsUseCaseProvider, addDocumentPersonnaliseUseCaseProvider, getMissionByIdUseCaseProvider (+35 more)
...
Cohesion: 0.13
Nodes (16): ../ai_provider.dart, dart:async, AiProvider, apiKey, GeminiRestProvider, generateStructuredText, _modelName, providerName (+8 more)

### Community 101 - "mesuresEssaisProvider"
Cohesion: 0.07
Nodes (30): mesuresEssaisProvider, _sauvegarder, _transfererEssais, _annuler, build, ConditionsMesureScreen, _ConditionsMesureScreenState, createState (+22 more)
...
Cohesion: 0.06
Nodes (33): Mission, build, _buildEmptyState, _buildHeaderClientCard, _buildLocalInspectionCard, _buildStatusBadge, _confirmDelete, createState (+25 more)

### Community 124 - "package:inspec_app/models/description_installations.dart"
Cohesion: 0.08
Nodes (21): package:inspec_app/features/description_installations/data/mappers/description_installations_mapper.dart, package:inspec_app/features/description_installations/domain/entities/description_installations_entity.dart, package:inspec_app/features/description_installations/domain/entities/installation_item_entity.dart, package:inspec_app/models/description_installations.dart, package:inspec_app/models/pdf/installation_description_pdf_data.dart, package:inspec_app/services/installation_description_sync_service.dart, package:inspec_app/services/pdf/pdf_report_service.dart, main (+13 more)

### Community 125 - "pdf_report_light_service.dart"
Cohesion: 0.09
Nodes (19): RenseignementsGenerauxMapper, toEntity, toModel, _buildGeneralInfoTable, _buildLightingInspectionTable, _buildLightingPhotosList, conformeBgColor, conformeTextColor (+11 more)
...
### Community 136 - "backup_job_store.dart"
Cohesion: 0.20
...
Cohesion: 0.09
Nodes (21): hashCode, operator, read, typeId, VerificateurAdapter, write, createdAt, email (+13 more)
...
Cohesion: 0.09
Nodes (21): audit_finding.dart, audit_finding_inventory_engine.dart, clear, isBusy, PersistenceQueue, _queues, _cacheTtl, collect (+13 more)
...
### Community 149 - "mission_summary_card.dart"
Cohesion: 0.22
...
### Community 183 - "normative_search_suggestions_widget.dart"
Cohesion: 0.15
...
Cohesion: 0.10
Nodes (20): AuditInstallationsElectriquesAdapter, AuditInstallationsElectriques, _areItemListsEqual, _auditBox, buildLocalisationMap, _celluleAliases, clearAllDescriptions, clearSectionDescriptions (+12 more)
...
### Community 190 - "schema_step.dart"
Cohesion: 0.13
Nodes (15): build, createState, errorMessage, _handleOptionSelected, _hasAttemptedNext, initState, _isFirstLoad, isFormValid (+7 more)
...
### Community 202 - "audit_installations_repository_impl.dart"
Cohesion: 0.25
...
Cohesion: 0.07
Nodes (27): ../../domain/models/local_backup_item.dart, isKnown, _noneOptions, _normalize, resolve, SourceStatusResolver, statusConnue, statusInconnue (+19 more)
...
Cohesion: 0.07
Nodes (23): build, _buildDateItem, _formatDate, mission, MissionDatesSection, build, _buildDocumentItem, mission (+15 more)
...
Cohesion: 0.13
Nodes (10): package:inspec_app/features/mesures_essais/data/mappers/mesures_essais_mapper.dart, package:inspec_app/features/mesures_essais/domain/entities/mesures_essais_entities.dart, package:inspec_app/models/mesures_essais.dart, package:inspec_app/services/document_generation/essai_declenchement_helper.dart, main, main, main, main (+2 more)
...
### Community 213 - "_ReportGenerationLoaderState"
Cohesion: 0.67
...
### Community 242 - "recent_mission_item_widget.dart"
Cohesion: 0.29
...
### Community 246 - "mission_team_traceability_card.dart"
Cohesion: 0.33
Nodes (5): build, _buildPersonTile, isDarkMode, mission, MissionTeamTraceabilityCard
...
Cohesion: 0.07
Nodes (48): @HiveType, AlimentationAdapter, BasseTensionLocalAdapter, BasseTensionZoneAdapter, CelluleAdapter, CircuitTerminalEquipementAdapter, CoffretArmoireAdapter, DepartEquipementAdapter (+40 more)

### Community 250 - "audit_installations_local_data_source.dart"
Cohesion: 0.50
...
## Knowledge Gaps
- **6648 isolated node(s):** `XCTest`, `queryText`, `equipmentType`, `selectedReferenceNormative`, `selectedFamilleRisque` (+6643 more)
...
- **Why does `Mission` connect `package:inspec_app/models/mission.dart` to `hive_service.dart`, `ajouter_local_screen.dart`, `ajouter_coffret_screen.dart`, `mission_card.dart`, `avis_mesures_screen.dart`, `foudre_screen.dart`, `mission_local_data_source.dart`, `installation_detail.dart`, `backup_service.dart`, `pdf_photos_deduplication_test.dart`, `essais_declenchement_screen.dart`, `ajouter_foudre_screen.dart`, `jsa_step.dart`, `alimentation_site_mt_sequence_screen.dart`, `description_installations_form.dart`, `general_info_step.dart`, `sequence_screen.dart`, `demarrage_auto_screen.dart`, `mission.dart`, `detail_coffret_screen.dart`, `detail_local_screen.dart`, `MaterialPageRoute`, `paratonnerre_screen.dart`, `description_step.dart`, `mission_summary_card.dart`, `package:inspec_app/services/hive_service.dart`, `audit_installations.dart`, `mission_team_section.dart`, `pdf_schema_section_test.dart`, `moyenne_tension_screen.dart`, `essais_isolement_screen.dart`, `status_action_button.dart`, `summary_step.dart`, `mission_analytics_detail_screen.dart`, `ajouter_zone_screen.dart`, `classement_emplacement_screen.dart`, `arret_urgence_screen.dart`, `foudre_local_data_source.dart`, `basse_tension_screen.dart`, `qr_scan_coffret_screen.dart`, `jsa_standalone_screen.dart`, `mission_hub_screen.dart`, `description_installations_sequence.dart`, `prises_terre_screen.dart`, `schema_step.dart`, `documents_step.dart`, `cpi_tests_list_screen.dart`, `lighting_summary_screen.dart`, `continuite_resistance_screen.dart`, `create_mission_screen.dart`, `descriptionInstallationsProvider`, `mission_detail_screen.dart`, `pdf_report_context.dart`, `List`, `package:flutter/material.dart`, `classement_zone_screen.dart`, `radio_sequence_screen.dart`, `jsa_local_data_source.dart`, `radio_selection_screen.dart`, `mesuresEssaisProvider`, `client_logo_screen.dart`, `item_detail_screen.dart`, `cpi_test_form_screen.dart`, `mesures_essais_screen.dart`, `mission_backup_card.dart`, `recent_mission_item_widget.dart`, `cpi_sequence_screen.dart`, `mission_team_traceability_card.dart`, `renseignements_generaux_local_data_source.dart`, `@HiveType`, `description_installations_screen/description_installations.dart`?**
...
- **What connects `XCTest`, `queryText`, `equipmentType` to the rest of the system?**
  _6648 weakly-connected nodes found - possible documentation gaps or missing edges._

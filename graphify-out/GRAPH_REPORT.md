...
## Corpus Check
- 568 files · ~939,626 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9879 nodes · 13644 edges · 311 communities (273 shown, 16 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f3fef79b`
...
## Communities (311 total, 16 thin omitted)
...
Cohesion: 0.05
Nodes (51): dart:io, Directory, DescriptionInstallations, package:archive/archive_io.dart, package:crypto/crypto.dart, package:flutter/services.dart, package:hive/hive.dart, package:inspec_app/features/backup/data/datasources/backup_job_store.dart (+43 more)
...
### Community 26 - "class"
Cohesion: 0.24
Nodes (10): getCurrentUserUseCaseProvider, getRenseignementsGenerauxUseCaseProvider, saveRenseignementsGenerauxUseCaseProvider, load, missionId, ref, RenseignementsGenerauxNotifier, updateField (+2 more)
...
Cohesion: 0.05
Nodes (44): Color, InvalidFormatDialog, MissionHeader, AnalyticsKpiCards, build, _buildKpiCard, data, isDarkMode (+36 more)

### Community 30 - "State"
Cohesion: 0.06
Nodes (46): _EtapeInformationsGenerales, ForgotPasswordScreen, _ForgotPasswordScreenState, MissionCard, _MissionCardState, MissionDetailScreen, _MissionDetailScreenState, _EquipmentSourceAutocompleteField (+38 more)
...
### Community 38 - "mesures_essais_screen.dart"
Cohesion: 0.07
...
Cohesion: 0.05
Nodes (48): descriptionInstallationsProvider, build, _buildCpiContent, _buildInfoCard, _buildNonItNotice, _buildStatusOption, CpiSequenceScreen, _CpiSequenceScreenState (+40 more)
...
### Community 86 - "package:inspec_app/services/pdf/pdf_report_styles.dart"
Cohesion: 0.03
Nodes (58): Container, buildSection12AvisGlobal, buildSection13LeveeDangers, buildSection14ProchaineEcheance, buildSection15Signature, Q18ConclusionBuilder, buildSection10Dangers, buildSection11Statistiques (+50 more)
...
### Community 95 - "pdf_final_page_builder.dart"
Cohesion: 0.15
...
Cohesion: 0.03
Nodes (96): dart:convert, FixedColumnWidth, Font, ensureCurrentUserInJSA, getMissionIntervenants, getMissionIntervenantsNoms, IntervenantsService, _syncLegacyFieldsWithJsa (+88 more)
...
Cohesion: 0.06
Nodes (51): ConsumerState, ConsumerStatefulWidget, mesuresEssaisProvider, AjouterCoffretScreen, _AjouterCoffretScreenState, _transfererEssais, AvisMesuresScreen, _AvisMesuresScreenState (+43 more)
...
Cohesion: 0.04
Nodes (78): BoxDecoration, NewPage, package:inspec_app/services/ai/executive_summary_snapshot.dart, package:inspec_app/services/pdf/builders/pdf_classement_foudre_builder.dart, package:inspec_app/services/pdf/builders/pdf_executive_summary_builder.dart, package:inspec_app/services/pdf/builders/pdf_final_page_builder.dart, package:inspec_app/services/pdf/builders/pdf_sommaire_builder.dart, package:inspec_app/services/pdf/builders/pdf_statistics_builder.dart (+70 more)

### Community 115 - "pdf_mesures_essais_builder.dart"
Cohesion: 0.03
Nodes (85): PointEquipmentInfo, accentColor, addMesuresEssaisPages, armoireGroups, armoireName, _bodyBold, _bodyText, borderColor (+77 more)
...
Cohesion: 0.05
Nodes (36): _buildAlimentationSiteMtTable, _buildCpiTable, buildDescriptionInstallationsMulti, _buildInstallationTable, _buildInstallationTableFromRows, collectRiskZonesAndLocauxForTesting, _collectRiskZonesAndLocauxStructured, fontBold (+28 more)

### Community 144 - "package:flutter_riverpod/flutter_riverpod.dart"
Cohesion: 0.10
Nodes (20): msalRecommendationServiceProvider, build, createState, _isVisible, MsalRecommendationBanner, _MsalRecommendationBannerState, onConnectPressed, _annuler (+12 more)
...
Cohesion: 0.02
Nodes (113): FoudreAdapter, class FakePathProviderPlatform extends, class MockPathProviderPlatform extends, toEntity, toModel, VerificateurMapper, FoudreMapper, toEntity (+105 more)
...
### Community 194 - "List"
Cohesion: 0.06
Nodes (30): cpi_test_form_screen.dart, createdAt, data, InstallationItemEntity, photoPaths, build, _buildEmptyState, _buildStatusBadge (+22 more)
...
Cohesion: 0.03
Nodes (55): dart:typed_data, dart:ui, _cleanUpChunks, _mergeChunkListToDestination, mergePdfFiles, PdfMergeProgressCallback, PdfMergerService, audit (+47 more)
...
### Community 266 - "jsa_provider.dart"
Cohesion: 0.24
Nodes (10): getJsaByMissionUseCaseProvider, saveJsaUseCaseProvider, JsaNotifier, load, missionId, ref, updateJsa, package:inspec_app/core/providers/auth_providers.dart (+2 more)

### Community 267 - "mesures_essais_provider.dart"
Cohesion: 0.24
...
### Community 280 - "pareto_forensic_analysis_test.dart"
Cohesion: 0.22
...
### Community 281 - "../dispositions_constructives_registry.dart"
Cohesion: 0.25
...
### Community 282 - "stat_card_widget.dart"
Cohesion: 0.25
Nodes (7): IconData, build, color, icon, StatCardWidget, title, value

### Community 283 - "date_selector_widget.dart"
Cohesion: 0.25
...
### Community 286 - "package:inspec_app/services/normative_search_service.dart"
Cohesion: 0.32
...
### Community 291 - "distribution_item_widget.dart"
Cohesion: 0.29
...
### Community 305 - "foudreObservationsProvider"
Cohesion: 0.67

...
## Corpus Check
- 465 files · ~487,038 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8226 nodes · 11394 edges · 263 communities (229 shown, 22 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `838123ef`
...
Cohesion: 0.01
Nodes (159): BasseTensionZoneAdapter, CelluleAdapter, CircuitTerminalEquipementAdapter, hashCode, operator, PointVerificationAdapter, read, typeId (+151 more)
...
Cohesion: 0.03
Nodes (95): class FakePathProviderPlatform extends, toEntity, toModel, VerificateurMapper, FoudreMapper, toEntity, toModel, call (+87 more)
...
Cohesion: 0.03
Nodes (61): package:flutter_test/flutter_test.dart, package:inspec_app/core/utils/source_status_resolver.dart, package:inspec_app/features/audit_installations/data/mappers/audit_installations_mapper.dart, package:inspec_app/features/audit_installations/domain/entities/audit_installations_entities.dart, package:inspec_app/models/audit_installations_electriques.dart, package:inspec_app/services/cellule_types_registry.dart, package:inspec_app/services/dispositions_constructives_registry.dart, package:inspec_app/services/equipment_number_service.dart (+53 more)

### Community 9 - "jsa.dart"
Cohesion: 0.02
Nodes (98): hashCode, JSAAdapter, JSADangersAdapter, JSAEPIAdapter, JSAExigencesGeneralesAdapter, JSAInspecteurAdapter, JSAPlanUrgenceAdapter, JSAVerificationFinaleAdapter (+90 more)

### Community 10 - "mesures_essais.dart"
Cohesion: 0.02
Nodes (109): @HiveType, AlimentationAdapter, BasseTensionLocalAdapter, ElementControleAdapter, MoyenneTensionLocalAdapter, MoyenneTensionZoneAdapter, ObservationLibreAdapter, TransformateurMTBTAdapter (+101 more)
...
Cohesion: 0.07
Nodes (35): @Timeout, dart:io, Directory, package:archive/archive_io.dart, package:crypto/crypto.dart, package:flutter/services.dart, package:inspec_app/features/backup/data/datasources/backup_job_store.dart, package:inspec_app/features/backup/data/datasources/local_backup_store.dart (+27 more)
...
Cohesion: 0.06
Nodes (39): MyApp, InvalidFormatDialog, MissionInfoSection, AnalyticsKpiCards, build, _buildKpiCard, data, isDarkMode (+31 more)

### Community 30 - "State"
Cohesion: 0.06
Nodes (46): _EtapeInformationsGenerales, BackupScreen, _BackupScreenState, ForgotPasswordScreen, _ForgotPasswordScreenState, SortDialog, _SortDialogState, MissionDetailScreen (+38 more)
...
Cohesion: 0.05
Nodes (65): ../entities/verificateur_entity.dart, init, sl, checkLoginStatusUseCaseProvider, getMissionsUseCaseProvider, VerificateurRepositoryImpl, getCurrentUser, isUserLoggedIn (+57 more)
...
### Community 54 - "class"
Cohesion: 0.07
Nodes (41): AsyncValue, getAuditInstallationsUseCaseProvider, saveAuditInstallationsUseCaseProvider, getCurrentUserUseCaseProvider, getJsaByMissionUseCaseProvider, saveJsaUseCaseProvider, getMesuresEssaisUseCaseProvider, saveMesuresEssaisUseCaseProvider (+33 more)
...
Cohesion: 0.04
Nodes (56): addInstallationItemUseCaseProvider, getDescriptionInstallationsUseCaseProvider, removeInstallationItemUseCaseProvider, updateDescriptionSelectionUseCaseProvider, updateInstallationItemUseCaseProvider, addFoudreObservation, addInstallationItem, clearAllDescriptions (+48 more)
...
Cohesion: 0.09
Nodes (26): descriptionInstallationsProvider, _addItem, build, _confirmDeleteAllDescriptions, _deleteItem, _editItem, _ajouterObservation, _analyseRisqueFoudre (+18 more)
...
### Community 74 - "auth_local_data_source.dart"
Cohesion: 0.12
...
Cohesion: 0.07
Nodes (30): _autreController, _autreSavedValue, build, _cpiAnneeFabrication, _cpiMarqueController, _cpiNumeroSerieController, _cpiReportAlarme, _cpiSeuilController (+22 more)
...
### Community 101 - "mission_activity_tracker.dart"
Cohesion: 0.09
...
### Community 106 - "lighting_inspection_model_test.dart"
Cohesion: 0.12
...
### Community 107 - "installation_description_pdf_data.dart"
Cohesion: 0.11
...
Cohesion: 0.05
Nodes (45): AuditInstallationsElectriquesAdapter, DescriptionInstallationsAdapter, MissionAdapter, getOrCreateJSA, _jsaBox, JsaLocalDataSource, JsaLocalDataSourceImpl, _missionBox (+37 more)
...
Cohesion: 0.07
Nodes (32): ../entities/audit_installations_entities.dart, ../entities/mesures_essais_entities.dart, AuditInstallationsRepositoryImpl, AuditInstallationsRepository, getOrCreateAuditInstallations, saveAuditInstallations, call, GetAuditInstallationsUseCase (+24 more)
...
### Community 130 - "package:inspec_app/services/hive_service.dart"
Cohesion: 0.04
Nodes (50): build, init, main, migratePointsVerificationPriorite, setPreferredOrientations, build, createState, dispose (+42 more)
...
### Community 136 - "renseignements_generaux_repository_impl.dart"
Cohesion: 0.07
Nodes (25): ../datasources/renseignements_generaux_local_data_source.dart, ../../domain/entities/renseignements_generaux_entity.dart, ../../domain/repositories/renseignements_generaux_repository.dart, ../entities/renseignements_generaux_entity.dart, RenseignementsGenerauxMapper, toEntity, toModel, getOrCreateRenseignementsGeneraux (+17 more)
...
### Community 149 - "normative_search_suggestions_widget.dart"
Cohesion: 0.15
...
### Community 162 - "backup_job_store.dart"
Cohesion: 0.20
...
Cohesion: 0.04
Nodes (59): Column, Font, buildCoverPage, buildIntervenantsEtResponsabilitesPage, cachedClientLogoImg, cachedClientQrImg, coverInfoRow, docStatus (+51 more)
...
### Community 167 - "int get"
Cohesion: 0.07
Nodes (28): FoudreAdapter, hashCode, operator, read, typeId, write, hashCode, LastReportAdapter (+20 more)
...
### Community 170 - "pdf_observations_synthesis_evolution_test.dart"
Cohesion: 0.40
Nodes (4): Container, SizedBox, Table, main
...
Cohesion: 0.08
Nodes (23): DateTime, BackupPreferences, copyWith, fromJson, isAutoBackupEnabled, recommendationDismissCount, recommendationLastShown, requiresCharging (+15 more)
...
Cohesion: 0.24
Nodes (10): ConsumerWidget, backupOrchestratorStateProvider, backupSyncNotifierProvider, build, _refresh, build, GlobalBackupProgressOverlay, AuthWrapper (+2 more)
...
Cohesion: 0.17
Nodes (8): package:inspec_app/features/mesures_essais/data/mappers/mesures_essais_mapper.dart, package:inspec_app/features/mesures_essais/domain/entities/mesures_essais_entities.dart, package:inspec_app/models/mesures_essais.dart, main, main, main, main, main
...
Cohesion: 0.11
Nodes (16): build, _getStatusColor, _getStatusIcon, MissionStatusBadge, _normalizeStatus, status, build, completedMissions (+8 more)

## Knowledge Gaps
- **6433 isolated node(s):** `XCTest`, `queryText`, `equipmentType`, `selectedReferenceNormative`, `selectedFamilleRisque` (+6428 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 6722 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **22 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Mission` connect `Mission` to `hive_service.dart`, `ajouter_local_screen.dart`, `ajouter_coffret_screen.dart`, `mission_card.dart`, `avis_mesures_screen.dart`, `foudre_screen.dart`, `mission_local_data_source.dart`, `backup_service.dart`, `pdf_photos_deduplication_test.dart`, `mesures_essais.dart`, `essais_declenchement_screen.dart`, `ajouter_foudre_screen.dart`, `cpi_sequence_screen.dart`, `general_info_step.dart`, `description_installations_form.dart`, `jsa_step.dart`, `sequence_screen.dart`, `mesuresEssaisProvider`, `mission.dart`, `lighting_mission_detail_screen.dart`, `detail_coffret_screen.dart`, `detail_local_screen.dart`, `detail_zone_screen.dart`, `paratonnerre_screen.dart`, `arret_urgence_screen.dart`, `mission_execution.dart`, `audit_installations.dart`, `package:inspec_app/models/mission.dart`, `mission_team_section.dart`, `moyenne_tension_screen.dart`, `dart:io`, `essais_isolement_screen.dart`, `summary_step.dart`, `alimentation_site_mt_sequence_screen.dart`, `ajouter_zone_screen.dart`, `classement_emplacement_screen.dart`, `foudre_local_data_source.dart`, `basse_tension_screen.dart`, `status_action_button.dart`, `qr_scan_coffret_screen.dart`, `jsa_standalone_screen.dart`, `mission_hub_screen.dart`, `lighting_inspection.dart`, `description_installations_sequence.dart`, `prises_terre_screen.dart`, `schema_step.dart`, `lighting_summary_screen.dart`, `continuite_resistance_screen.dart`, `create_mission_screen.dart`, `descriptionInstallationsProvider`, `mission_detail_screen.dart`, `pdf_report_context.dart`, `mesures_essais_screen.dart`, `classement_zone_screen.dart`, `mission_analytics_detail_screen.dart`, `VoidCallback?`, `radio_sequence_screen.dart`, `radio_selection_screen.dart`, `status_selector_modal.dart`, `client_logo_screen.dart`, `item_detail_screen.dart`, `demarrage_auto_screen.dart`, `mission_backup_card.dart`, `installation_detail.dart`, `description_step.dart`, `description_installations_screen/description_installations.dart`?**
...
- **Why does `SaveRenseignementsGenerauxUseCase` connect `renseignements_generaux_repository_impl.dart` to `injection_container.dart`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **What connects `XCTest`, `queryText`, `equipmentType` to the rest of the system?**
  _6433 weakly-connected nodes found - possible documentation gaps or missing edges._
